...
#include "Goal_HuntTarget_Z.h"
#include "Goal_DodgeSideToSide_Z.h"
...
//------------------------------- Activate ------------------------------------
//-----------------------------------------------------------------------------
void Goal_AttackTarget_Z::Activate()
{
  m_iStatus = active;
  ...
  if (m_pOwner->GetTargetSys()->isTargetShootable())
  {
    ...
    {
      AddSubgoal(new Goal_DodgeSideToSide_Z(m_pOwner));
    }

    //if not able to strafe, head directly at the target's position 
    else
    {
      AddSubgoal(new Goal_SeekToPosition_Z(m_pOwner, m_pOwner->GetTargetBot()->Pos()));
    }
  }
  ...
  {
    AddSubgoal(new Goal_HuntTarget_Z(m_pOwner));
  }
}

//-------------------------- Process ------------------------------------------
//-----------------------------------------------------------------------------
int Goal_AttackTarget_Z::Process()
{
