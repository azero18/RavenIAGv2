#ifndef RAVEN_FEATUREZ_H
#define RAVEN_FEATUREZ_H
//-----------------------------------------------------------------------------
//
...
public:
  ...
  static double DistanceToItem(Raven_Bot_Z* pBot, int ItemType);
  ...
  static double IndividualWeaponStrength(Raven_Bot_Z* pBot, int WeaponType);
  ...
  static double TotalWeaponStrength(Raven_Bot_Z* pBot);
};
