...
//-----------------------------------------------------------------------------
double Raven_Feature_Z::DistanceToItem(Raven_Bot_Z* pBot, int ItemType)
{
...
//-----------------------------------------------------------------------------
double GetMaxRoundsBotCanCarryForWeapon_Z(int WeaponType)
{
  switch(WeaponType)
  {
  case type_rail_gun:
...
//-----------------------------------------------------------------------------
double Raven_Feature_Z::IndividualWeaponStrength(Raven_Bot_Z* pBot,
                                               int        WeaponType)
{
  ...
  if (wp)
  {
    return wp->NumRoundsRemaining() / GetMaxRoundsBotCanCarryForWeapon_Z(WeaponType);
  }
...
//--------------------- TotalWeaponStrength --------------
//-----------------------------------------------------------------------------
double Raven_Feature_Z::TotalWeaponStrength(Raven_Bot_Z* pBot)
{
  const double MaxRoundsForShotgun = GetMaxRoundsBotCanCarryForWeapon_Z(type_shotgun);
  const double MaxRoundsForRailgun = GetMaxRoundsBotCanCarryForWeapon_Z(type_rail_gun);
  const double MaxRoundsForRocketLauncher = GetMaxRoundsBotCanCarryForWeapon_Z(type_rocket_launcher);
...
//
//-----------------------------------------------------------------------------
double Raven_Feature_Z::Health(Raven_Bot_Z* pBot)
{
