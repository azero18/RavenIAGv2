; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
rtc$TMZ	SEGMENT
...
EXTRN	?getEDMG@Raven_SensoryMemory@@QAEHPAVRaven_Bot@@@Z:PROC ; Raven_SensoryMemory::getEDMG
...
__unwindtable$?Update@Raven_TargetingSystem@@QAEXXZ DD 0ffffffffH
	...
	DD	FLAT:__unwindfunclet$?Update@Raven_TargetingSystem@@QAEXXZ$6
	DD	08H
	DD	FLAT:__unwindfunclet$?Update@Raven_TargetingSystem@@QAEXXZ$7
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
_TEXT	SEGMENT
tv279 = -336						; size = 4
...
$T141630 = -188						; size = 12
$T141629 = -176						; size = 16
_calculus$133288 = -160					; size = 8
_estimedHealth$133287 = -152				; size = 4
_tdist$133286 = -148					; size = 8
_dist$133283 = -140					; size = 8
_curBot$133275 = -128					; size = 12
_distMod$133267 = -112					; size = 8
_RocketStrenght$133266 = -104				; size = 8
_ShotgunStrenght$133265 = -96				; size = 8
_RailgunStrenght$133264 = -88				; size = 8
_dist$133259 = -80					; size = 8
_curBot$133196 = -68					; size = 12
_think_type$ = -52					; size = 4
...
; 28   :   //NEW
; 29   :   int think_type = m_pOwner->GetBrain()->GetType();
	...
	mov	DWORD PTR _think_type$[ebp], eax

; 30   : 
; 31   :   if (think_type == goal_think)

	cmp	DWORD PTR _think_type$[ebp], 0
	jne	$LN15@Update

; 32   :   {
; 33   : 	  std::list<Raven_Bot*>::const_iterator curBot = SensedBots.begin();

	lea	eax, DWORD PTR $T141630[ebp]
	push	eax
	lea	ecx, DWORD PTR _SensedBots$[ebp]
...
$LN14@Update:
	...
	mov	BYTE PTR $T141631[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	lea	ecx, DWORD PTR $T141632[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T141631[ebp]
	test	eax, eax
	je	$LN12@Update
...
; 38   : 		{
; 39   : 		  double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());

	lea	ecx, DWORD PTR $T141633[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx]
	...
	add	esp, 8
	fstp	QWORD PTR _dist$133259[ebp]

; 40   : 
; 41   : 		  if (dist < ClosestDistSoFar)

	fld	QWORD PTR _ClosestDistSoFar$[ebp]
	fcomp	QWORD PTR _dist$133259[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $LN10@Update

; 42   : 		  {
; 43   : 			ClosestDistSoFar = dist;

	fld	QWORD PTR _dist$133259[ebp]
	fstp	QWORD PTR _ClosestDistSoFar$[ebp]

; 44   : 			m_pCurrentTarget = *curBot;
...
; 49   :   //NEW: aplicar heuristica do dano estimado
; 50   :   if (think_type == goal_think_Z)

	cmp	DWORD PTR _think_type$[ebp], 18		; 00000012H
	jne	$LN9@Update

; 51   :   {
; 52   : 	  //ClosestDistSoFar = 0;
; 53   : 
; 54   : 	  double RailgunStrenght = Raven_Feature::IndividualWeaponStrength(m_pOwner,type_rail_gun);
	...
	add	esp, 8
	fstp	QWORD PTR _RailgunStrenght$133264[ebp]

; 55   : 	  double ShotgunStrenght = Raven_Feature::IndividualWeaponStrength(m_pOwner,type_shotgun);
	...
	call	?IndividualWeaponStrength@Raven_Feature@@SANPAVRaven_Bot@@H@Z ; Raven_Feature::IndividualWeaponStrength
	add	esp, 8
	fstp	QWORD PTR _ShotgunStrenght$133265[ebp]

; 56   : 	  double RocketStrenght = Raven_Feature::IndividualWeaponStrength(m_pOwner, type_rocket_launcher);
	...
	call	?IndividualWeaponStrength@Raven_Feature@@SANPAVRaven_Bot@@H@Z ; Raven_Feature::IndividualWeaponStrength
	add	esp, 8
	fstp	QWORD PTR _RocketStrenght$133266[ebp]

; 57   : 	  
; 58   : 	  double distMod;
; 59   : 		  if ((RailgunStrenght > ShotgunStrenght)||(RocketStrenght > ShotgunStrenght))

	fld	QWORD PTR _ShotgunStrenght$133265[ebp]
	fcomp	QWORD PTR _RailgunStrenght$133264[ebp]
	fnstsw	ax
	test	ah, 5
	jnp	SHORT $LN7@Update
	fld	QWORD PTR _ShotgunStrenght$133265[ebp]
	fcomp	QWORD PTR _RocketStrenght$133266[ebp]
	fnstsw	ax
	test	ah, 5
	jp	SHORT $LN8@Update
$LN7@Update:
...
; 60   : 		  {
; 61   : 			distMod = ((RailgunStrenght+RocketStrenght)/2)+ShotgunStrenght;

	fld	QWORD PTR _RailgunStrenght$133264[ebp]
	fadd	QWORD PTR _RocketStrenght$133266[ebp]
	fdiv	QWORD PTR __real@4000000000000000
	fadd	QWORD PTR _ShotgunStrenght$133265[ebp]
	fstp	QWORD PTR _distMod$133267[ebp]
...
; 65   : 		  }
; 66   : 
; 67   : 	  std::list<Raven_Bot*>::const_iterator curBot = SensedBots.begin();

	lea	eax, DWORD PTR $T141635[ebp]
	push	eax
	lea	ecx, DWORD PTR _SensedBots$[ebp]
	call	?begin@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::begin
	...
	push	edx
	lea	ecx, DWORD PTR _curBot$133275[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T141635[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	jmp	SHORT $LN5@Update
$LN4@Update:

; 68   : 	  for (curBot; curBot != SensedBots.end(); ++curBot)

	lea	ecx, DWORD PTR _curBot$133275[ebp]
	call	??E?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAEAAV01@XZ ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator++
$LN5@Update:
	lea	eax, DWORD PTR $T141637[ebp]
	push	eax
	lea	ecx, DWORD PTR _SensedBots$[ebp]
	call	?end@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::end
	...
	lea	ecx, DWORD PTR _curBot$133275[ebp]
	call	??9?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator!=
	mov	BYTE PTR $T141636[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T141637[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T141636[ebp]
	test	eax, eax
	je	$LN3@Update

; 69   : 	  {
; 70   : 		//make sure the bot is alive and that it is not the owner
; 71   : 		if ((*curBot)->isAlive() && (*curBot != m_pOwner) )
...
; 72   : 		{	  
; 73   : 
; 74   : 		  double dist = Vec2DDistance((*curBot)->Pos(), m_pOwner->Pos());
	...
	add	esp, 8
	fstp	QWORD PTR _dist$133283[ebp]

; 75   : 
; 76   : 		  double tdist = dist*distMod;

	fld	QWORD PTR _dist$133283[ebp]
	fmul	QWORD PTR _distMod$133267[ebp]
	fstp	QWORD PTR _tdist$133286[ebp]

; 77   : 
; 78   : 		  int estimedHealth = (100 - m_pOwner->GetSensoryMem()->getEDMG(*curBot))/100;
	...
	call	?GetSensoryMem@Raven_Bot@@QBEQAVRaven_SensoryMemory@@XZ ; Raven_Bot::GetSensoryMem
	mov	ecx, eax
	call	?getEDMG@Raven_SensoryMemory@@QAEHPAVRaven_Bot@@@Z ; Raven_SensoryMemory::getEDMG
	...
	mov	ecx, 100				; 00000064H
	idiv	ecx
	mov	DWORD PTR _estimedHealth$133287[ebp], eax

; 79   : 
; 80   : 		  double calculus = tdist / estimedHealth;

	fild	DWORD PTR _estimedHealth$133287[ebp]
	fdivr	QWORD PTR _tdist$133286[ebp]
	fstp	QWORD PTR _calculus$133288[ebp]

; 81   : 
; 82   : 		  if (calculus < ClosestDistSoFar)

	fld	QWORD PTR _ClosestDistSoFar$[ebp]
	fcomp	QWORD PTR _calculus$133288[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $LN1@Update

; 83   : 		  {
; 84   : 			ClosestDistSoFar = calculus;

	fld	QWORD PTR _calculus$133288[ebp]
	fstp	QWORD PTR _ClosestDistSoFar$[ebp]

; 85   : 			m_pCurrentTarget = *curBot;
...
__unwindfunclet$?Update@Raven_TargetingSystem@@QAEXXZ$6:
	lea	ecx, DWORD PTR _curBot$133275[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?Update@Raven_TargetingSystem@@QAEXXZ$7:
	lea	ecx, DWORD PTR $T141637[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
...
; 181  :   bool          isAlive()const{return m_Status == alive;}
...
; 97   :   return m_pOwner->GetSensoryMem()->isOpponentWithinFOV(m_pCurrentTarget);
...
; 102  :   return m_pOwner->GetSensoryMem()->isOpponentShootable(m_pCurrentTarget);
...
; 107  :   return m_pOwner->GetSensoryMem()->GetLastRecordedPositionOfOpponent(m_pCurrentTarget);
...
; 112  :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenVisible(m_pCurrentTarget);
...
; 117  :   return m_pOwner->GetSensoryMem()->GetTimeOpponentHasBeenOutOfView(m_pCurrentTarget);
...
$T141836 = -84						; size = 4
$T141835 = -80						; size = 4
__Next$135352 = -72					; size = 12
__Iter$135346 = -52					; size = 12
__Next$135342 = -32					; size = 12
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Where$ = 8						; size = 12
__Right$ = 20						; size = 4
...
; 1442 : 				for (const_iterator _Next = _First; _Next != _Last; )
	...
	push	ecx
	lea	ecx, DWORD PTR __Next$135342[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	BYTE PTR __$EHRec$[ebp+8], 3
$LN6@Splice:
...
; 1444 : 					const_iterator _Iter = _Next++;
	...
	push	0
	lea	ecx, DWORD PTR __Iter$135346[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Next$135342[ebp]
...
; 1445 : 					_Orphan_ptr(_Right, _Iter._Ptr);
	...
	mov	edx, DWORD PTR __Iter$135346[ebp+8]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1458 : 			for (const_iterator _Next = _First; _Next != _Last; ++_Next)
	...
	push	eax
	lea	ecx, DWORD PTR __Next$135352[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1460 : 			_Right.erase(_First, _Last);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T141841[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv292[ebp], eax
	lea	eax, DWORD PTR $T141842[ebp]
	push	eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	mov	ecx, DWORD PTR __Right$[ebp]
...
; 1081 : 		{	// erase [_First, _Last)
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T141932[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 1082 : 		if (_First == begin() && _Last == end())

	lea	eax, DWORD PTR $T141923[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?begin@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T141932[ebp]
	or	edx, 1
	mov	DWORD PTR $T141932[ebp], edx
	...
	mov	ecx, DWORD PTR $T141932[ebp]
	or	ecx, 2
	mov	DWORD PTR $T141932[ebp], ecx
...
$LN8@erase:
	...
	mov	BYTE PTR $T141922[ebp], cl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T141932[ebp]
	and	edx, 2
	je	SHORT $LN15@erase
	and	DWORD PTR $T141932[ebp], -3		; fffffffdH
	lea	ecx, DWORD PTR $T141924[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN15@erase:
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	...
	and	eax, 1
	je	SHORT $LN16@erase
	and	DWORD PTR $T141932[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141923[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN16@erase:
...
__unwindfunclet$?erase@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@0@Z$4:
	...
	and	eax, 4
	je	$LN18@erase
	and	DWORD PTR $T141932[ebp], -5		; fffffffbH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN18@erase:
	ret	0
...
__unwindfunclet$?_Make_iter@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T142020[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T142020[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
__unwindfunclet$?erase@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$3:
	...
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T142036[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
__unwindfunclet$??$insert@PAVRaven_Bot@@@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@$$QAPAVRaven_Bot@@@Z$2:
	mov	eax, DWORD PTR $T142070[ebp]
	and	eax, 1
	je	$LN6@insert
	and	DWORD PTR $T142070[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN6@insert:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T142103[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T142103[ebp], 0
	...
	mov	ecx, DWORD PTR $T142103[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T142103[ebp]
...
; 742  : 		return (_Make_iter(--_Where));
	...
	mov	ecx, DWORD PTR $T142131[ebp]
	or	ecx, 1
	mov	DWORD PTR $T142131[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$emplace@PAVRaven_Bot@@@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@$$QAPAVRaven_Bot@@@Z$3:
	...
	and	eax, 1
	je	$LN7@emplace
	and	DWORD PTR $T142131[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN7@emplace:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T142178[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T142178[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@PAVRaven_Bot@@@std@@YA$$QAPAVRaven_Bot@@AAPAV1@@Z ; std::forward<Raven_Bot *>
	add	esp, 4
	mov	edx, DWORD PTR $T142178[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T142178[ebp]
