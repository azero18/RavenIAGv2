; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
;	COMDAT rtc$TMZ
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_targetingsystem.cpp
rtc$TMZ	SEGMENT
...
$LN5@Update:
	...
	mov	BYTE PTR $T139013[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	lea	ecx, DWORD PTR $T139014[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T139013[ebp]
	test	edx, edx
	je	$LN3@Update
...
; 33   :       double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
	...
	add	esp, 8
	fstp	QWORD PTR _dist$131765[ebp]

; 34   : 
; 35   :       if (dist < ClosestDistSoFar)

	fld	QWORD PTR _ClosestDistSoFar$[ebp]
	fcomp	QWORD PTR _dist$131765[ebp]
	fnstsw	ax
...
; 37   :         ClosestDistSoFar = dist;
	...
	fld	QWORD PTR _dist$131765[ebp]
	fstp	QWORD PTR _ClosestDistSoFar$[ebp]
...
; 206  :   bool          isAlive()const{return m_Status == alive;}
...
; 266  :   Raven_SensoryMemory* const         GetSensoryMem()const{return m_pSensoryMem;}
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T139119[ebp]
	or	ecx, 1
	mov	DWORD PTR $T139119[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T139124[ebp]
	or	eax, 1
	mov	DWORD PTR $T139124[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 706  : 					_Right._Mysize);
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 5
	lea	ecx, DWORD PTR $T139147[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T139145[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T139143[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
...
$T139201 = -84						; size = 4
$T139200 = -80						; size = 4
__Next$133798 = -72					; size = 12
__Iter$133792 = -52					; size = 12
__Next$133788 = -32					; size = 12
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Where$ = 8						; size = 12
__Right$ = 20						; size = 4
...
; 1442 : 				for (const_iterator _Next = _First; _Next != _Last; )
	...
	push	ecx
	lea	ecx, DWORD PTR __Next$133788[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	BYTE PTR __$EHRec$[ebp+8], 3
$LN6@Splice:
...
; 1444 : 					const_iterator _Iter = _Next++;
	...
	push	0
	lea	ecx, DWORD PTR __Iter$133792[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Next$133788[ebp]
...
; 1445 : 					_Orphan_ptr(_Right, _Iter._Ptr);
	...
	mov	edx, DWORD PTR __Iter$133792[ebp+8]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1458 : 			for (const_iterator _Next = _First; _Next != _Last; ++_Next)
	...
	push	eax
	lea	ecx, DWORD PTR __Next$133798[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1459 : 				insert(_Where, (_Ty &&)*_Next);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T139203[ebp], esp
	lea	eax, DWORD PTR __Where$[ebp]
	push	eax
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv284[ebp], eax
	lea	ecx, DWORD PTR $T139204[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1460 : 			_Right.erase(_First, _Last);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T139206[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv291[ebp], eax
	lea	eax, DWORD PTR $T139207[ebp]
	push	eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	mov	ecx, DWORD PTR __Right$[ebp]
...
; 1081 : 		{	// erase [_First, _Last)
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T139297[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 1082 : 		if (_First == begin() && _Last == end())

	lea	eax, DWORD PTR $T139288[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?begin@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T139297[ebp]
	or	edx, 1
	mov	DWORD PTR $T139297[ebp], edx
	...
	mov	ecx, DWORD PTR $T139297[ebp]
	or	ecx, 2
	mov	DWORD PTR $T139297[ebp], ecx
...
$LN8@erase:
	...
	mov	BYTE PTR $T139287[ebp], cl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T139297[ebp]
	and	edx, 2
	je	SHORT $LN15@erase
	and	DWORD PTR $T139297[ebp], -3		; fffffffdH
	lea	ecx, DWORD PTR $T139289[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN15@erase:
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR $T139297[ebp]
	and	eax, 1
	je	SHORT $LN16@erase
	and	DWORD PTR $T139297[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T139288[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN16@erase:
	movzx	ecx, BYTE PTR $T139287[ebp]
	test	ecx, ecx
	je	SHORT $LN2@erase
...
; 1090 : 				_First = erase(_First);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T139292[ebp], esp
	lea	eax, DWORD PTR __First$[ebp]
	push	eax
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv206[ebp], eax
	lea	ecx, DWORD PTR $T139293[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
__unwindfunclet$?erase@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@0@Z$4:
	...
	and	eax, 4
	je	$LN18@erase
	and	DWORD PTR $T139297[ebp], -5		; fffffffbH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN18@erase:
	ret	0
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	...
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T139350[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	edx, DWORD PTR $T139385[ebp]
	or	edx, 1
	mov	DWORD PTR $T139385[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T139385[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T139385[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	ecx, DWORD PTR $T139401[ebp]
	or	ecx, 1
	mov	DWORD PTR $T139401[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T139401[ebp]
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T139401[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
__unwindfunclet$??$insert@PAVRaven_Bot@@@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@$$QAPAVRaven_Bot@@@Z$2:
	...
	and	eax, 1
	je	$LN6@insert
	and	DWORD PTR $T139435[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN6@insert:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T139468[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T139468[ebp], 0
	...
	mov	ecx, DWORD PTR $T139468[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T139468[ebp]
...
; 742  : 		return (_Make_iter(--_Where));
	...
	mov	ecx, DWORD PTR $T139496[ebp]
	or	ecx, 1
	mov	DWORD PTR $T139496[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$emplace@PAVRaven_Bot@@@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@1@$$QAPAVRaven_Bot@@@Z$3:
	mov	eax, DWORD PTR $T139496[ebp]
	and	eax, 1
	je	$LN7@emplace
	and	DWORD PTR $T139496[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN7@emplace:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T139543[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T139543[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@PAVRaven_Bot@@@std@@YA$$QAPAVRaven_Bot@@AAPAV1@@Z ; std::forward<Raven_Bot *>
	add	esp, 4
	mov	edx, DWORD PTR $T139543[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T139543[ebp]
