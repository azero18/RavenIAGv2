; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG136981 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG136982 DB	'SeparationWeight', 00H
	ORG $+3
$SG136983 DB	'WanderWeight', 00H
	ORG $+3
$SG136984 DB	'WallAvoidanceWeight', 00H
$SG136985 DB	'SeekWeight', 00H
	ORG $+1
$SG136986 DB	'ArriveWeight', 00H
	ORG $+3
$SG136987 DB	'ViewDistance', 00H
CONST	ENDS
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\game\movingentity.h
_TEXT	ENDS
...
; 138  :     RunningTot += (Vec2DNormalize(ForceToAdd) * MagnitudeToAdd); 
	...
	push	edx
	lea	eax, DWORD PTR $T146233[ebp]
	push	eax
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	ecx, DWORD PTR $T146234[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_map.h
_TEXT	ENDS
...
; 215  :                             * m_pRaven_Bot->MaxSpeed();
	...
	push	eax
	lea	ecx, DWORD PTR $T146280[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	edx, DWORD PTR $T146281[ebp]
	push	edx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
...
$T146299 = -108						; size = 8
$T146298 = -100						; size = 16
_DesiredVelocity$137081 = -80				; size = 16
_speed$137073 = -56					; size = 8
_DecelerationTweaker$137072 = -44			; size = 8
_dist$ = -36						; size = 8
...
; 238  :     const double DecelerationTweaker = 0.3;
	...
	fstp	QWORD PTR _DecelerationTweaker$137072[ebp]
...
; 242  :     double speed =  dist / ((double)deceleration * DecelerationTweaker);     
	...
	fmul	QWORD PTR _DecelerationTweaker$137072[ebp]
	fdivr	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR _speed$137073[ebp]
...
; 245  :     speed = MinOf(speed, m_pRaven_Bot->MaxSpeed());
	...
	mov	ecx, DWORD PTR [ecx+8]
	call	?MaxSpeed@MovingEntity@@QBENXZ		; MovingEntity::MaxSpeed
	fstp	QWORD PTR $T146299[ebp]
	lea	edx, DWORD PTR $T146299[ebp]
	push	edx
	lea	eax, DWORD PTR _speed$137073[ebp]
	push	eax
...
; 250  :     Vector2D DesiredVelocity =  ToTarget * speed / dist;
	...
	fstp	QWORD PTR [esp]
	sub	esp, 8
	fld	QWORD PTR _speed$137073[ebp]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _ToTarget$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T146300[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR _DesiredVelocity$137081[ebp]
	push	eax
...
; 284  :                                        m_pRaven_Bot->Pos());
	...
	lea	eax, DWORD PTR $T146317[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T146318[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Side@MovingEntity@@QBE?AUVector2D@@XZ	; MovingEntity::Side
	push	eax
	lea	ecx, DWORD PTR $T146319[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Heading@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Heading
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\2d\transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\2d\c2dmatrix.h
...
$T146367 = -168						; size = 16
$T146366 = -152						; size = 16
_OverShoot$137131 = -132				; size = 16
_w$137121 = -112					; size = 4
_flr$137117 = -108					; size = 4
...
; 315  :     for (unsigned int w=0; w<walls.size(); ++w)
	...
	mov	DWORD PTR _w$137121[ebp], 0
	jmp	SHORT $LN6@WallAvoida
$LN5@WallAvoida:
	mov	ecx, DWORD PTR _w$137121[ebp]
	add	ecx, 1
	mov	DWORD PTR _w$137121[ebp], ecx
$LN6@WallAvoida:
	...
	cmp	DWORD PTR _w$137121[ebp], eax
	jae	$LN4@WallAvoida
...
; 322  :                              point))
	...
	push	eax
	lea	ecx, DWORD PTR $T146366[ebp]
	push	ecx
	mov	edx, DWORD PTR _w$137121[ebp]
	push	edx
	mov	ecx, DWORD PTR _walls$[ebp]
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _flr$137117[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
...
; 343  :       Vector2D OverShoot = m_Feelers[flr] - ClosestPoint;
	...
	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	push	ecx
	mov	edx, DWORD PTR _flr$137117[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	??A?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAEAAUVector2D@@I@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::operator[]
	push	eax
	lea	eax, DWORD PTR _OverShoot$137131[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 347  :       SteeringForce = walls[ClosestWall]->Normal() * OverShoot.Length();
	...
	lea	ecx, DWORD PTR _OverShoot$137131[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T146369[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\2d\geometry.h
...
; 363  :                  m_pRaven_Bot->Heading() * m_pRaven_Bot->Speed();
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T146398[ebp]
	push	ecx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T146399[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T146400[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T146401[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 368  :   m_Feelers[1] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T146402[ebp]
	push	edx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T146403[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T146404[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 373  :   m_Feelers[2] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T146407[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR $T146408[ebp]
	push	ecx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 395  :       Vector2D ToAgent = m_pRaven_Bot->Pos() - (*it)->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T146434[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR _ToAgent$137304[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 399  :       SteeringForce += Vec2DNormalize(ToAgent)/ToAgent.Length();
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR _ToAgent$137304[ebp]
	push	edx
	lea	eax, DWORD PTR $T146435[ebp]
	push	eax
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T146500[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146500[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 859  : 			erase(begin() + _Newsize, end());
	...
	push	ecx
	lea	edx, DWORD PTR $T146533[ebp]
	push	edx
	lea	eax, DWORD PTR $T146532[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T146531[ebp], esp
	mov	eax, DWORD PTR tv198[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv201[ebp], eax
	lea	ecx, DWORD PTR $T146534[ebp]
	push	ecx
	...
	lea	ecx, DWORD PTR $T146533[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T146532[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T146530[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
...
_TEXT	SEGMENT
__Size$140572 = -28					; size = 4
__Ptr$140565 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$140565[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$140565[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	mov	DWORD PTR __Size$140572[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 4
	add	eax, DWORD PTR __Ptr$140565[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$140572[ebp]
	shl	edx, 4
	add	edx, DWORD PTR __Ptr$140565[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$140565[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T146655[ebp]
	or	eax, 1
	mov	DWORD PTR $T146655[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	eax, DWORD PTR $T146660[ebp]
	or	eax, 1
	mov	DWORD PTR $T146660[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$140602[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$140602[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@IAEXPAUVector2D@@0@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::_Destroy
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$140602[ebp]
	mov	DWORD PTR [ecx+8], edx
$LN3@erase:
...
; 1213 : 		return (_Make_iter(_First));
	...
	mov	edx, DWORD PTR $T146677[ebp]
	or	edx, 1
	mov	DWORD PTR $T146677[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@0@Z$7:
	mov	eax, DWORD PTR $T146677[ebp]
	and	eax, 1
	je	$LN14@erase
	and	DWORD PTR $T146677[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN14@erase:
	ret	0
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T146740[ebp]
	or	edx, 1
	mov	DWORD PTR $T146740[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T146740[ebp]
	and	eax, 1
	je	$LN5@operator@12
	and	DWORD PTR $T146740[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@12:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	edx, DWORD PTR $T146763[ebp]
	or	edx, 1
	mov	DWORD PTR $T146763[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
__unwindfunclet$?_Make_iter@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T146763[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T146763[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$142206[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$142206[ebp]
	push	edx
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T146821[ebp], eax
	lea	eax, DWORD PTR $T146821[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$139240[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	mov	ecx, DWORD PTR __Newsize$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$139240[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$139240[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T146897[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T146897[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$139219[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$139219[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T146959[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146959[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T146959[ebp]
	and	eax, 1
	je	$LN5@operator@14
	and	DWORD PTR $T146959[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@14:
	ret	0
...
;	COMDAT xdata$x
; File c:\users\pedro\documents\github\raveniagv2\common\game\entityfunctiontemplates.h
xdata$x	SEGMENT
...
$T147009 = -77						; size = 1
$T147008 = -76						; size = 12
_range$142308 = -64					; size = 8
_to$142304 = -52					; size = 16
_it$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_entity$ = 8						; size = 4
_others$ = 12						; size = 4
...
$LN4@TagNeighbo:
	...
	lea	ecx, DWORD PTR _it$[ebp]
	call	??9?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator!=
	mov	BYTE PTR $T147009[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T147010[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T147009[ebp]
	test	eax, eax
	je	$LN2@TagNeighbo
...
; 56   :     Vector2D to = (*it)->Pos() - entity->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR _to$142304[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 60   :     double range = radius + (*it)->BRadius();
	...
	fstp	QWORD PTR _range$142308[ebp]
...
; 63   :     if ( ((*it) != entity) && (to.LengthSq() < range*range))
	...
	lea	ecx, DWORD PTR _to$142304[ebp]
	call	?LengthSq@Vector2D@@QBENXZ		; Vector2D::LengthSq
	fld	QWORD PTR _range$142308[ebp]
	fmul	QWORD PTR _range$142308[ebp]
	fcompp
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 672  : 		_Val_type(_First), _Ptr_cat(_First, _First));
	...
	add	esp, 8
	mov	BYTE PTR $T147052[ebp], al
	movzx	edx, BYTE PTR $T147052[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T147059[ebp], al
	movzx	edx, BYTE PTR $T147059[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T147062[ebp], al
	movzx	edx, BYTE PTR $T147062[ebp]
	push	edx
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$143045[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$143045[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve@2:
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T147103[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147103[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T147108[ebp]
	or	eax, 1
	mov	DWORD PTR $T147108[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T147113[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T147113[ebp], 0
	...
	mov	ecx, DWORD PTR $T147113[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T147113[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T147179[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T147179[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@UVector2D@@@std@@YA$$QAUVector2D@@AAU1@@Z ; std::forward<Vector2D>
	add	esp, 4
	mov	edx, DWORD PTR $T147179[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edx], ecx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T147191[ebp], al
	movzx	edx, BYTE PTR $T147191[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
	call	??$_Val_type@PAUVector2D@@@std@@YAPAUVector2D@@PAU1@@Z ; std::_Val_type<Vector2D *>
