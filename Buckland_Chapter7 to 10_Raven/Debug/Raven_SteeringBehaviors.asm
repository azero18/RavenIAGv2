; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG136471 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG136472 DB	'SeparationWeight', 00H
	ORG $+3
$SG136473 DB	'WanderWeight', 00H
	ORG $+3
$SG136474 DB	'WallAvoidanceWeight', 00H
$SG136475 DB	'SeekWeight', 00H
	ORG $+1
$SG136476 DB	'ArriveWeight', 00H
	ORG $+3
$SG136477 DB	'ViewDistance', 00H
CONST	ENDS
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\script\scriptor.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
_TEXT	ENDS
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\game\movingentity.h
_TEXT	ENDS
...
; 138  :     RunningTot += (Vec2DNormalize(ForceToAdd) * MagnitudeToAdd); 
	...
	push	edx
	lea	eax, DWORD PTR $T145707[ebp]
	push	eax
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	ecx, DWORD PTR $T145708[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_map.h
_TEXT	ENDS
...
; 215  :                             * m_pRaven_Bot->MaxSpeed();
	...
	push	eax
	lea	ecx, DWORD PTR $T145754[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	edx, DWORD PTR $T145755[ebp]
	push	edx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
...
_TEXT	ENDS
PUBLIC	?Flee@Raven_Steering@@AAE?AUVector2D@@ABU2@@Z	; Raven_Steering::Flee
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
_TEXT	SEGMENT
$T145775 = -92						; size = 16
...
___$ReturnUdt$ = 8					; size = 4
_target$ = 12						; size = 4
?Flee@Raven_Steering@@AAE?AUVector2D@@ABU2@@Z PROC	; Raven_Steering::Flee
; _this$ = ecx
...
; 224  :  
; 225  :   Vector2D DesiredVelocity = Vec2DNormalize(m_pRaven_Bot->Pos() - target)
; 226  :                             * m_pRaven_Bot->MaxSpeed();
...
; 227  : 
; 228  :   return (DesiredVelocity - m_pRaven_Bot->Velocity());

	lea	ecx, DWORD PTR $T145775[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
...
$LN3@Flee:
	...
	DB	121					; 00000079H
	DB	0
?Flee@Raven_Steering@@AAE?AUVector2D@@ABU2@@Z ENDP	; Raven_Steering::Flee
_TEXT	ENDS
...
$T145781 = -108						; size = 8
$T145780 = -100						; size = 16
_DesiredVelocity$136583 = -80				; size = 16
_speed$136575 = -56					; size = 8
_DecelerationTweaker$136574 = -44			; size = 8
_dist$ = -36						; size = 8
...
; 240  :   Vector2D ToTarget = target - m_pRaven_Bot->Pos();

	lea	eax, DWORD PTR $T145780[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 241  : 
; 242  :   //calculate the distance to the target
; 243  :   double dist = ToTarget.Length();
...
; 246  :   {
; 247  :     //because Deceleration is enumerated as an int, this value is required
; 248  :     //to provide fine tweaking of the deceleration..
; 249  :     const double DecelerationTweaker = 0.3;

	fld	QWORD PTR __real@3fd3333333333333
	fstp	QWORD PTR _DecelerationTweaker$136574[ebp]

; 250  : 
; 251  :     //calculate the speed required to reach the target given the desired
; 252  :     //deceleration
; 253  :     double speed =  dist / ((double)deceleration * DecelerationTweaker);     

	fild	DWORD PTR _deceleration$[ebp]
	fmul	QWORD PTR _DecelerationTweaker$136574[ebp]
	fdivr	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR _speed$136575[ebp]

; 254  : 
; 255  :     //make sure the velocity does not exceed the max
; 256  :     speed = MinOf(speed, m_pRaven_Bot->MaxSpeed());

	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?MaxSpeed@MovingEntity@@QBENXZ		; MovingEntity::MaxSpeed
	fstp	QWORD PTR $T145781[ebp]
	lea	edx, DWORD PTR $T145781[ebp]
	push	edx
	lea	eax, DWORD PTR _speed$136575[ebp]
	push	eax
...
; 257  : 
; 258  :     //from here proceed just like Seek except we don't need to normalize 
; 259  :     //the ToTarget vector because we have already gone to the trouble
; 260  :     //of calculating its length: dist. 
; 261  :     Vector2D DesiredVelocity =  ToTarget * speed / dist;

	sub	esp, 8
	fld	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR [esp]
	sub	esp, 8
	fld	QWORD PTR _speed$136575[ebp]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _ToTarget$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T145782[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR _DesiredVelocity$136583[ebp]
	push	eax
	call	??K@YA?AUVector2D@@ABU0@N@Z		; operator/
	add	esp, 16					; 00000010H

; 262  : 
; 263  :     return (DesiredVelocity - m_pRaven_Bot->Velocity());

	lea	ecx, DWORD PTR $T145783[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
...
; 277  :   //first, add a small random vector to the target's position
; 278  :   m_vWanderTarget += Vector2D(RandomClamped() * m_dWanderJitter,
; 279  :                               RandomClamped() * m_dWanderJitter);
...
; 280  : 
; 281  :   //reproject this new vector back on to a unit circle
; 282  :   m_vWanderTarget.Normalize();
...
; 283  : 
; 284  :   //increase the length of the vector to the same as the radius
; 285  :   //of the wander circle
; 286  :   m_vWanderTarget *= m_dWanderRadius;
...
; 287  : 
; 288  :   //move the target into a position WanderDist in front of the agent
; 289  :   Vector2D target = m_vWanderTarget + Vector2D(m_dWanderDistance, 0);
...
; 290  : 
; 291  :   //project the target into world space
; 292  :   Vector2D Target = PointToWorldSpace(target,
; 293  :                                        m_pRaven_Bot->Heading(),
; 294  :                                        m_pRaven_Bot->Side(), 
; 295  :                                        m_pRaven_Bot->Pos());

	lea	eax, DWORD PTR $T145799[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T145800[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Side@MovingEntity@@QBE?AUVector2D@@XZ	; MovingEntity::Side
	push	eax
	lea	ecx, DWORD PTR $T145801[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
	call	?Heading@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Heading
...
; 296  : 
; 297  :   //and steer towards it
; 298  :   return Target - m_pRaven_Bot->Pos(); 

	lea	edx, DWORD PTR $T145802[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\2d\transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\2d\c2dmatrix.h
...
$T145849 = -168						; size = 16
$T145848 = -152						; size = 16
_OverShoot$136633 = -132				; size = 16
_w$136623 = -112					; size = 4
_flr$136619 = -108					; size = 4
...
; 309  :   //the feelers are contained in a std::vector, m_Feelers
; 310  :   CreateFeelers();
...
; 311  :   
; 312  :   double DistToThisIP    = 0.0;

	fldz
	fstp	QWORD PTR _DistToThisIP$[ebp]

; 313  :   double DistToClosestIP = MaxDouble;

	fld	QWORD PTR _MaxDouble
	fstp	QWORD PTR _DistToClosestIP$[ebp]

; 314  : 
; 315  :   //this will hold an index into the vector of walls
; 316  :   int ClosestWall = -1;

	mov	DWORD PTR _ClosestWall$[ebp], -1

; 317  : 
; 318  :   Vector2D SteeringForce,

	lea	ecx, DWORD PTR _SteeringForce$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 319  :             point,         //used for storing temporary info

	lea	ecx, DWORD PTR _point$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 320  :             ClosestPoint;  //holds the closest intersection point

	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 321  : 
; 322  :   //examine each feeler in turn
; 323  :   for (unsigned int flr=0; flr<m_Feelers.size(); ++flr)

	mov	DWORD PTR _flr$136619[ebp], 0
	jmp	SHORT $LN9@WallAvoida
$LN8@WallAvoida:
	mov	eax, DWORD PTR _flr$136619[ebp]
	add	eax, 1
	mov	DWORD PTR _flr$136619[ebp], eax
$LN9@WallAvoida:
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	cmp	DWORD PTR _flr$136619[ebp], eax
	jae	$LN7@WallAvoida

; 324  :   {
; 325  :     //run through each wall checking for any intersection points
; 326  :     for (unsigned int w=0; w<walls.size(); ++w)

	mov	DWORD PTR _w$136623[ebp], 0
	jmp	SHORT $LN6@WallAvoida
$LN5@WallAvoida:
	mov	ecx, DWORD PTR _w$136623[ebp]
	add	ecx, 1
	mov	DWORD PTR _w$136623[ebp], ecx
$LN6@WallAvoida:
	...
	cmp	DWORD PTR _w$136623[ebp], eax
	jae	$LN4@WallAvoida

; 327  :     {
; 328  :       if (LineIntersection2D(m_pRaven_Bot->Pos(),
; 329  :                              m_Feelers[flr],
; 330  :                              walls[w]->From(),
; 331  :                              walls[w]->To(),
; 332  :                              DistToThisIP,
; 333  :                              point))
	...
	push	eax
	lea	ecx, DWORD PTR $T145848[ebp]
	push	ecx
	mov	edx, DWORD PTR _w$136623[ebp]
	push	edx
	mov	ecx, DWORD PTR _walls$[ebp]
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _flr$136619[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
...
; 334  :       {
; 335  :         //is this the closest found so far? If so keep a record
; 336  :         if (DistToThisIP < DistToClosestIP)
...
; 337  :         {
; 338  :           DistToClosestIP = DistToThisIP;
...
; 346  : 
; 347  :   
; 348  :     //if an intersection point has been detected, calculate a force  
; 349  :     //that will direct the agent away
; 350  :     if (ClosestWall >=0)

	cmp	DWORD PTR _ClosestWall$[ebp], 0
	jl	SHORT $LN1@WallAvoida

; 351  :     {
; 352  :       //calculate by what distance the projected position of the agent
; 353  :       //will overshoot the wall
; 354  :       Vector2D OverShoot = m_Feelers[flr] - ClosestPoint;

	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	push	ecx
	mov	edx, DWORD PTR _flr$136619[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	??A?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAEAAUVector2D@@I@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::operator[]
	push	eax
	lea	eax, DWORD PTR _OverShoot$136633[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH

; 355  : 
; 356  :       //create a force in the direction of the wall normal, with a 
; 357  :       //magnitude of the overshoot
; 358  :       SteeringForce = walls[ClosestWall]->Normal() * OverShoot.Length();

	lea	ecx, DWORD PTR _OverShoot$136633[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T145851[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\2d\geometry.h
...
; 372  :   //feeler pointing straight in front
; 373  :   m_Feelers[0] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength *
; 374  :                  m_pRaven_Bot->Heading() * m_pRaven_Bot->Speed();
...
; 375  : 
; 376  :   //feeler to left
; 377  :   Vector2D temp = m_pRaven_Bot->Heading();
...
; 378  :   Vec2DRotateAroundOrigin(temp, HalfPi * 3.5);
...
; 379  :   m_Feelers[1] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T145884[ebp]
	push	edx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T145885[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T145886[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 380  : 
; 381  :   //feeler to right
; 382  :   temp = m_pRaven_Bot->Heading();

	lea	eax, DWORD PTR $T145887[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Heading@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Heading
...
; 383  :   Vec2DRotateAroundOrigin(temp, HalfPi * 0.5);
...
; 384  :   m_Feelers[2] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T145888[ebp]
	push	ecx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T145889[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR $T145890[ebp]
	push	ecx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 394  :   //iterate through all the neighbors and calculate the vector from the
; 395  :   Vector2D SteeringForce;

	lea	ecx, DWORD PTR _SteeringForce$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 396  : 
; 397  :   std::list<Raven_Bot*>::const_iterator it = neighbors.begin();
...
; 398  :   for (it; it != neighbors.end(); ++it)
...
$LN4@Separation:
	...
	mov	BYTE PTR $T145913[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145914[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T145913[ebp]
	test	ecx, ecx
	je	$LN2@Separation

; 399  :   {
; 400  :     //make sure this agent isn't included in the calculations and that
; 401  :     //the agent being examined is close enough. ***also make sure it doesn't
; 402  :     //include the evade target ***
; 403  :     if((*it != m_pRaven_Bot) && (*it)->IsTagged() &&
; 404  :       (*it != m_pTargetAgent1))
...
; 405  :     {
; 406  :       Vector2D ToAgent = m_pRaven_Bot->Pos() - (*it)->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T145916[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR _ToAgent$136806[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH

; 407  : 
; 408  :       //scale the force inversely proportional to the agents distance  
; 409  :       //from its neighbor.
; 410  :       SteeringForce += Vec2DNormalize(ToAgent)/ToAgent.Length();

	lea	ecx, DWORD PTR _ToAgent$136806[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR _ToAgent$136806[ebp]
	push	edx
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T145982[ebp]
	or	ecx, 1
	mov	DWORD PTR $T145982[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T145987[ebp]
	or	eax, 1
	mov	DWORD PTR $T145987[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 859  : 			erase(begin() + _Newsize, end());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T146013[ebp], esp
	mov	eax, DWORD PTR tv198[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv201[ebp], eax
	lea	ecx, DWORD PTR $T146016[ebp]
	push	ecx
...
_TEXT	SEGMENT
__Size$140074 = -28					; size = 4
__Ptr$140067 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$140067[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$140067[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	mov	DWORD PTR __Size$140074[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 4
	add	eax, DWORD PTR __Ptr$140067[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$140074[ebp]
	shl	edx, 4
	add	edx, DWORD PTR __Ptr$140067[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$140067[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T146137[ebp]
	or	eax, 1
	mov	DWORD PTR $T146137[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	eax, DWORD PTR $T146142[ebp]
	or	eax, 1
	mov	DWORD PTR $T146142[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$140104[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$140104[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@IAEXPAUVector2D@@0@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::_Destroy
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$140104[ebp]
	mov	DWORD PTR [ecx+8], edx
$LN3@erase:
...
; 1213 : 		return (_First);
	...
	mov	ecx, DWORD PTR $T146157[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146157[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@0@Z$6:
	mov	eax, DWORD PTR $T146157[ebp]
	and	eax, 1
	je	$LN13@erase
	and	DWORD PTR $T146157[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN13@erase:
	ret	0
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T146220[ebp]
	or	edx, 1
	mov	DWORD PTR $T146220[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T146220[ebp]
	and	eax, 1
	je	$LN5@operator@12
	and	DWORD PTR $T146220[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@12:
	ret	0
...
__unwindfunclet$?_Make_iter@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T146243[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T146243[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\lua-5.1.3\include\luahelperfunctions.h
_DATA	SEGMENT
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$141706[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$141706[ebp]
	push	edx
	lea	eax, DWORD PTR $T141707[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T146287[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T141707[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T146301[ebp], eax
	lea	eax, DWORD PTR $T146301[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$138742[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	mov	ecx, DWORD PTR __Newsize$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$138742[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$138742[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T146377[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T146377[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$138721[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$138721[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T146439[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146439[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T146439[ebp]
	and	eax, 1
	je	$LN5@operator@14
	and	DWORD PTR $T146439[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@14:
	ret	0
...
;	COMDAT xdata$x
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\game\entityfunctiontemplates.h
xdata$x	SEGMENT
...
$T146489 = -77						; size = 1
$T146488 = -76						; size = 12
_range$141808 = -64					; size = 8
_to$141804 = -52					; size = 16
_it$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_entity$ = 8						; size = 4
_others$ = 12						; size = 4
...
$LN4@TagNeighbo:
	...
	lea	ecx, DWORD PTR _it$[ebp]
	call	??9?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::operator!=
	mov	BYTE PTR $T146489[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T146490[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T146489[ebp]
	test	eax, eax
	je	$LN2@TagNeighbo
...
; 56   :     Vector2D to = (*it)->Pos() - entity->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR _to$141804[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 60   :     double range = radius + (*it)->BRadius();
	...
	fstp	QWORD PTR _range$141808[ebp]
...
; 63   :     if ( ((*it) != entity) && (to.LengthSq() < range*range))
	...
	lea	ecx, DWORD PTR _to$141804[ebp]
	call	?LengthSq@Vector2D@@QBENXZ		; Vector2D::LengthSq
	fld	QWORD PTR _range$141808[ebp]
	fmul	QWORD PTR _range$141808[ebp]
	fcompp
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 672  : 		_Val_type(_First), _Ptr_cat(_First, _First));
	...
	add	esp, 8
	mov	BYTE PTR $T146532[ebp], al
	movzx	edx, BYTE PTR $T146532[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T146539[ebp], al
	movzx	edx, BYTE PTR $T146539[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T146542[ebp], al
	movzx	edx, BYTE PTR $T146542[ebp]
	push	edx
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$142545[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$142545[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve@2:
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T146583[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146583[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T146588[ebp]
	or	eax, 1
	mov	DWORD PTR $T146588[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	mov	ecx, DWORD PTR $T146593[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T146593[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T146659[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@UVector2D@@@std@@YA$$QAUVector2D@@AAU1@@Z ; std::forward<Vector2D>
	add	esp, 4
	mov	edx, DWORD PTR $T146659[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edx], ecx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T146671[ebp], al
	movzx	edx, BYTE PTR $T146671[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
	call	??$_Val_type@PAUVector2D@@@std@@YAPAUVector2D@@PAU1@@Z ; std::_Val_type<Vector2D *>
