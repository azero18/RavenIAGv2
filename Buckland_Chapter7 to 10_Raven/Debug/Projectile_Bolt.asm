; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\armory\Projectile_Bolt.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138048 DB	'Bolt_Mass', 00H
	ORG $+2
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138047 DB	'Bolt_MaxForce', 00H
	ORG $+2
$SG138049 DB	'Bolt_MaxSpeed', 00H
	ORG $+2
$SG138050 DB	'Bolt_Scale', 00H
	ORG $+1
$SG138051 DB	'Bolt_Damage', 00H
$SG138054 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	DB	'\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'j', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'i', 00H, 'l', 00H, 'e', 00H, '_', 00H, 'B', 00H
	DB	'o', 00H, 'l', 00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p'
	DB	00H, 00H, 00H
	ORG $+2
$SG138055 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\armory\projectile_bolt.cpp
rdata$r	SEGMENT
...
; 29   : {
	...
	push	OFFSET $SG138047
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138048
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138049
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
...
$T147814 = -60						; size = 16
$T147813 = -44						; size = 16
_dist$138073 = -24					; size = 8
_v$138072 = -12						; size = 4
_hit$138068 = -8					; size = 4
_this$ = -4						; size = 4
...
; 40   :   {
; 41   :     m_vVelocity = MaxSpeed() * Heading();

	lea	edx, DWORD PTR $T147813[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 42   : 
; 43   :     //make sure vehicle does not exceed maximum velocity
; 44   :     m_vVelocity.Truncate(m_dMaxSpeed);
...
; 48   : 
; 49   :     
; 50   :     //if the projectile has reached the target position or it hits an entity
; 51   :     //or wall it should explode/inflict damage/whatever and then mark itself
; 52   :     //as dead
; 53   : 
; 54   : 
; 55   :     //test to see if the line segment connecting the bolt's current position
; 56   :     //and previous position intersects with any bots.
; 57   :     Raven_Bot* hit = GetClosestIntersectingBot(m_vPosition - m_vVelocity,
; 58   :                                                m_vPosition);
	...
	mov	DWORD PTR _hit$138068[ebp], eax

; 59   :     
; 60   :     //if hit
; 61   :     if (hit)

	cmp	DWORD PTR _hit$138068[ebp], 0
	je	$LN2@Update
...
; 65   : 
; 66   :       //send a message to the bot to let it know it's been hit, and who the
; 67   :       //shot came from
...
; 72   :                               (void*)&m_iDamageInflicted);
	...
	push	eax
	push	3
	mov	ecx, DWORD PTR _hit$138068[ebp]
	call	?ID@BaseGameEntity@@QBEHXZ		; BaseGameEntity::ID
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 73   : 	  int v = pshooter->GetSensoryMem()->getEDMG(hit);

	mov	eax, DWORD PTR _hit$138068[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR _v$138072[ebp], eax

; 74   : 	  pshooter->GetSensoryMem()->setEDMG(hit,v+m_iDamageInflicted);

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _v$138072[ebp]
	add	eax, DWORD PTR [edx+192]
	push	eax
	mov	ecx, DWORD PTR _hit$138068[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 83   :                                                  m_pWorld->GetMap()->GetWalls()))
	...
	add	ecx, 200				; 000000c8H
	push	ecx
	lea	edx, DWORD PTR _dist$138073[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 24					; 00000018H
	sub	esp, 16					; 00000010H
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$143306[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143306[ebp]
	push	edx
	lea	eax, DWORD PTR $T143308[ebp]
	push	eax
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$139984[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$139984[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$139984[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$139963[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$139963[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T148038[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148038[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T148038[ebp]
	and	eax, 1
	je	$LN5@operator@4
	and	DWORD PTR $T148038[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@4:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$143323[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143323[ebp]
	push	edx
	lea	eax, DWORD PTR $T143324[ebp]
	push	eax
	call	??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z ; std::operator+<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR tv74[ebp], eax
...
$T148103 = -88						; size = 12
$T148102 = -73						; size = 1
_point$143685 = -68					; size = 16
_dist$143684 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
$LN6@FindCloses:
	...
	movzx	edx, BYTE PTR $T148102[ebp]
	test	edx, edx
	je	$LN4@FindCloses
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$143684[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$143685[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$143685[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$143684[ebp]
	push	ecx
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$143684[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$143684[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$143685[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$143685[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$143685[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$143685[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T148106[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T148106[ebp]
...
; 787  : 		return (const_iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T148199[ebp]
	or	eax, 1
	mov	DWORD PTR $T148199[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@PAPAVWall2D@@PBU_Container_base12@1@@Z ; std::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >
	mov	eax, DWORD PTR $T148204[ebp]
	or	eax, 1
	mov	DWORD PTR $T148204[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T148209[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148209[ebp], 0
	...
	mov	ecx, DWORD PTR $T148209[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T148209[ebp]
