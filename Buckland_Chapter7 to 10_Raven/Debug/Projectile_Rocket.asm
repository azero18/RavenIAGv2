; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\armory\Projectile_Rocket.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138051 DB	'Rocket_Mass', 00H
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138050 DB	'Rocket_MaxForce', 00H
$SG138052 DB	'Rocket_MaxSpeed', 00H
$SG138053 DB	'Rocket_Scale', 00H
	ORG $+3
$SG138054 DB	'Rocket_Damage', 00H
	ORG $+2
$SG138055 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG138058 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	...
	ORG $+2
$SG138059 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG138073 DB	'Rocket_ExplosionDecayRate', 00H
CONST	ENDS
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\armory\projectile_rocket.cpp
rdata$r	SEGMENT
...
; 31   : {
	...
	push	OFFSET $SG138050
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138051
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138052
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138053
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138054
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetInt@Scriptor@@QAEHPAD@Z		; Scriptor::GetInt
	push	eax
	lea	eax, DWORD PTR $T147751[ebp]
	push	eax
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\armory\raven_projectile.h
rdata$r	SEGMENT
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\time\crudetimer.h
CONST	SEGMENT
...
; 176  :   Vector2D      Facing()const{return m_vFacing;}
...
; 233  :   Raven_Game* const                  GetWorld(){return m_pWorld;} 
...
EXTRN	?setEDMG@Raven_SensoryMemory@@QAEXPAVRaven_Bot@@H@Z:PROC ; Raven_SensoryMemory::setEDMG
...
; 91   : 	  int v = pshooter->GetSensoryMem()->getEDMG(hit);
	...
	mov	DWORD PTR _v$138082[ebp], eax

; 92   : 	  pshooter->GetSensoryMem()->setEDMG(hit,v+m_iDamageInflicted);

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _v$138082[ebp]
	...
	call	?GetSensoryMem@Raven_Bot@@QBEQAVRaven_SensoryMemory@@XZ ; Raven_Bot::GetSensoryMem
	mov	ecx, eax
	call	?setEDMG@Raven_SensoryMemory@@QAEXPAVRaven_Bot@@H@Z ; Raven_SensoryMemory::setEDMG

; 93   :       //test for bots within the blast radius and inflict damage
; 94   :       InflictDamageOnBotsWithinBlastRadius();
...
; 95   :     }
; 96   : 
; 97   :     //test for impact with a wall
; 98   :     double dist;
; 99   :      if( FindClosestPointOfIntersectionWithWalls(m_vPosition - m_vVelocity,
; 100  :                                                  m_vPosition,
; 101  :                                                  dist,
; 102  :                                                  m_vImpactPoint,
; 103  :                                                  m_pWorld->GetMap()->GetWalls()))
...
; 104  :      {
; 105  :         m_bImpacted = true;

	mov	edx, DWORD PTR _this$[ebp]
	mov	BYTE PTR [edx+197], 1

; 106  :       
; 107  :         //test for bots within the blast radius and inflict damage
; 108  :         InflictDamageOnBotsWithinBlastRadius();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?InflictDamageOnBotsWithinBlastRadius@Rocket@@AAEXXZ ; Rocket::InflictDamageOnBotsWithinBlastRadius

; 109  : 
; 110  :         m_vPosition = m_vImpactPoint;
...
; 113  :     }
; 114  :     
; 115  :     //test to see if rocket has reached target position. If so, test for
; 116  :      //all bots in vicinity
; 117  :     const double tolerance = 5.0;   

	fld	QWORD PTR __real@4014000000000000
	fstp	QWORD PTR _tolerance$[ebp]

; 118  :     if (Vec2DDistanceSq(Pos(), m_vTarget) < tolerance*tolerance)
...
; 119  :     {
; 120  :       m_bImpacted = true;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+197], 1

; 121  : 
; 122  :       InflictDamageOnBotsWithinBlastRadius();
...
; 133  :   std::list<Raven_Bot*>::const_iterator curBot = m_pWorld->GetAllBots().begin();
...
; 134  : 
; 135  :   for (curBot; curBot != m_pWorld->GetAllBots().end(); ++curBot)
...
$LN4@InflictDam:
	...
	movzx	eax, BYTE PTR $T147904[ebp]
	test	eax, eax
	je	$LN2@InflictDam

; 136  :   {
; 137  :     if (Vec2DDistance(Pos(), (*curBot)->Pos()) < m_dBlastRadius + (*curBot)->BRadius())
	...
	fcomp	QWORD PTR tv252[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	$LN1@InflictDam

; 138  :     {
; 139  :       //send a message to the bot to let it know it's been hit, and who the
; 140  :       //shot came from
; 141  :       Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 142  :                               m_iShooterID,
; 143  :                               (*curBot)->ID(),
; 144  :                               Msg_TakeThatMF,
; 145  :                               (void*)&m_iDamageInflicted);
...
; 146  :       int v = pshooter->GetSensoryMem()->getEDMG(*curBot);
	...
	mov	ecx, eax
	call	?getEDMG@Raven_SensoryMemory@@QAEHPAVRaven_Bot@@@Z ; Raven_SensoryMemory::getEDMG
	mov	DWORD PTR _v$138245[ebp], eax

; 147  : 	  pshooter->GetSensoryMem()->setEDMG(*curBot,v+m_iDamageInflicted);

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _v$138245[ebp]
...
; 165  :     gdi->Circle(Pos(), m_dCurrentBlastRadius);

	mov	eax, DWORD PTR _this$[ebp]
	sub	esp, 8
	fld	QWORD PTR [eax+232]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T147948[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	sub	esp, 16					; 00000010H
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T147964[ebp]
	or	ecx, 1
	mov	DWORD PTR $T147964[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T147969[ebp]
	or	eax, 1
	mov	DWORD PTR $T147969[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$143526[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143526[ebp]
	push	edx
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$140178[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140178[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140178[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140157[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140157[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T148194[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148194[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T148194[ebp]
	and	eax, 1
	je	$LN5@operator@7
	and	DWORD PTR $T148194[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@7:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$143543[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143543[ebp]
	push	edx
...
;	COMDAT xdata$x
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\2d\wallintersectiontests.h
xdata$x	SEGMENT
...
$T148259 = -88						; size = 12
$T148258 = -73						; size = 1
_point$143791 = -68					; size = 16
_dist$143790 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$143790[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$143791[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$143791[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$143790[ebp]
	push	ecx
	lea	edx, DWORD PTR $T148260[ebp]
	push	edx
	lea	ecx, DWORD PTR _curWall$[ebp]
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$143790[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$143790[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$143791[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$143791[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$143791[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$143791[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T148262[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T148262[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T148263[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T148263[ebp]
$LN7@FindCloses:
...
; 1543 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$144483[ebp], edx
...
; 1545 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$144483[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 787  : 		return (const_iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T148337[ebp]
	or	eax, 1
	mov	DWORD PTR $T148337[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@PAPAVWall2D@@PBU_Container_base12@1@@Z ; std::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >
	mov	eax, DWORD PTR $T148342[ebp]
	or	eax, 1
	mov	DWORD PTR $T148342[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
