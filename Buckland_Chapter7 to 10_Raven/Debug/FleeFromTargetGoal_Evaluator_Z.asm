; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\FleeFromTargetGoal_Evaluator_Z.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?CalculateDesirability@FleeFromTargetGoal_Evaluator_Z@@UAENPAVRaven_Bot@@@Z ; FleeFromTargetGoal_Evaluator_Z::CalculateDesirability
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\fleefromtargetgoal_evaluator_z.cpp
CONST	SEGMENT
...
$T139912 = -44						; size = 4
$T139911 = -40						; size = 4
_Desirability$131928 = -32				; size = 8
_Tweaker$131927 = -20					; size = 8
_Distance$ = -12					; size = 8
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
?CalculateDesirability@FleeFromTargetGoal_Evaluator_Z@@UAENPAVRaven_Bot@@@Z PROC ; FleeFromTargetGoal_Evaluator_Z::CalculateDesirability
; _this$ = ecx
...
; 26   :     const double Tweaker = 0.2;
	...
	fstp	QWORD PTR _Tweaker$131927[ebp]
...
; 31   :     double Desirability = Tweaker * (Raven_Feature::DistanceToItem(pBot, type_health))/
; 32   : 		(1-Raven_Feature::Health(pBot));
	...
	call	?DistanceToItem@Raven_Feature@@SANPAVRaven_Bot@@H@Z ; Raven_Feature::DistanceToItem
	add	esp, 8
	fmul	QWORD PTR _Tweaker$131927[ebp]
	...
	fstp	QWORD PTR _Desirability$131928[ebp]
...
; 36   :     Clamp(Desirability, 0, 1);
	...
	mov	DWORD PTR $T139911[ebp], 1
	mov	DWORD PTR $T139912[ebp], 0
	lea	eax, DWORD PTR $T139911[ebp]
	push	eax
	lea	ecx, DWORD PTR $T139912[ebp]
	push	ecx
	lea	edx, DWORD PTR _Desirability$131928[ebp]
	push	edx
...
; 39   :     Desirability *= m_dCharacterBias;
	...
	fld	QWORD PTR _Desirability$131928[ebp]
...
$LN5@CalculateD:
	...
	DB	121					; 00000079H
	DB	0
?CalculateDesirability@FleeFromTargetGoal_Evaluator_Z@@UAENPAVRaven_Bot@@@Z ENDP ; FleeFromTargetGoal_Evaluator_Z::CalculateDesirability
_TEXT	ENDS
...
PUBLIC	?SetGoal@FleeFromTargetGoal_Evaluator_Z@@UAEXPAVRaven_Bot@@@Z ; FleeFromTargetGoal_Evaluator_Z::SetGoal
; Function compile flags: /Odtp /RTCsu
_TEXT	SEGMENT
tv84 = -44						; size = 4
tv70 = -40						; size = 4
...
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
?SetGoal@FleeFromTargetGoal_Evaluator_Z@@UAEXPAVRaven_Bot@@@Z PROC ; FleeFromTargetGoal_Evaluator_Z::SetGoal
; _this$ = ecx
...
; 51   : 	if (pBot->GetTargetBot() == nullptr){

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?GetTargetBot@Raven_Bot@@QBEQAV1@XZ	; Raven_Bot::GetTargetBot
	test	eax, eax
	jne	SHORT $LN2@SetGoal

; 52   : 		pBot->GetBrain()->AddGoal_FleeFromPosition((pBot->Pos())); }

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?GetBrain@Raven_Bot@@QAEQAVGoal_Think@@XZ ; Raven_Bot::GetBrain
	mov	DWORD PTR tv70[ebp], eax
	lea	eax, DWORD PTR $T139932[ebp]
	push	eax
	mov	ecx, DWORD PTR _pBot$[ebp]
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	jmp	SHORT $LN3@SetGoal
$LN2@SetGoal:

; 53   : 	else{pBot->GetBrain()->AddGoal_FleeFromPosition((pBot->GetTargetBot()->Pos()));

	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?GetBrain@Raven_Bot@@QAEQAVGoal_Think@@XZ ; Raven_Bot::GetBrain
	mov	DWORD PTR tv84[ebp], eax
	lea	ecx, DWORD PTR $T139933[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pBot$[ebp]
	call	?GetTargetBot@Raven_Bot@@QBEQAV1@XZ	; Raven_Bot::GetTargetBot
	mov	ecx, eax
...
; 55   : }
	...
	pop	ebp
	ret	4
?SetGoal@FleeFromTargetGoal_Evaluator_Z@@UAEXPAVRaven_Bot@@@Z ENDP ; FleeFromTargetGoal_Evaluator_Z::SetGoal
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\game\basegameentity.h
_TEXT	ENDS
...
; 236  :   Goal_Think* const                  GetBrain(){return m_pBrain;}
...
; 239  :   Raven_Bot* const                   GetTargetBot()const{return m_pTargSys->GetTarget();}
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\raven_targetingsystem.h
_TEXT	ENDS
...
PUBLIC	__$ArrayPad$
PUBLIC	?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z ; FleeFromTargetGoal_Evaluator_Z::RenderInfo
...
CONST	ENDS
xdata$x	SEGMENT
__ehfuncinfo$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z DD 019930522H
	DD	09H
	DD	FLAT:__unwindtable$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
__unwindtable$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$1
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$2
	DD	02H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$3
	DD	03H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$4
	DD	04H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
	DD	03H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
	DD	02H
	DD	FLAT:__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5
...
_Position$ = 8						; size = 16
_pBot$ = 24						; size = 4
?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z PROC ; FleeFromTargetGoal_Evaluator_Z::RenderInfo
; _this$ = ecx
...
; 60   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z
...
; 61   :   gdi->TextAtPos(Position, "H: " + ttos(CalculateDesirability(pBot), 2));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	fstp	QWORD PTR $T139944[ebp]
	push	2
	lea	ecx, DWORD PTR $T139944[ebp]
	push	ecx
	lea	edx, DWORD PTR $T131950[ebp]
	push	edx
	...
	push	ecx
	push	OFFSET $SG131952
	lea	edx, DWORD PTR $T131951[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR $T131951[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T131950[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 63   :   
; 64   :   std::string s = ttos(1-Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::DistanceToItem(pBot, type_health));
	...
	fld1
	fsubrp	ST(1), ST(0)
	fstp	QWORD PTR $T139946[ebp]
	push	2
	lea	ecx, DWORD PTR $T139945[ebp]
	push	ecx
	lea	edx, DWORD PTR $T131958[ebp]
	push	edx
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	push	ecx
	push	OFFSET $SG132024
	push	2
	lea	edx, DWORD PTR $T139946[ebp]
	push	edx
	lea	eax, DWORD PTR $T131955[ebp]
	push	eax
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	lea	ecx, DWORD PTR $T131956[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 7
	lea	ecx, DWORD PTR $T131955[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T131958[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >

; 65   :   gdi->TextAtPos(Position+Vector2D(0,15), s);
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$0:
	lea	ecx, DWORD PTR $T131950[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$1:
	lea	ecx, DWORD PTR $T131951[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$2:
	lea	ecx, DWORD PTR $T131958[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$3:
	lea	ecx, DWORD PTR $T131955[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$4:
	lea	ecx, DWORD PTR $T131956[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__unwindfunclet$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z$5:
	lea	ecx, DWORD PTR _s$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z:
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?RenderInfo@FleeFromTargetGoal_Evaluator_Z@@UAEXUVector2D@@PAVRaven_Bot@@@Z ENDP ; FleeFromTargetGoal_Evaluator_Z::RenderInfo
; Function compile flags: /Odtp /RTCsu
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$133119[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$133119[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$133119[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
__Pnext$15199 = -20					; size = 4
__Lock$15198 = -12					; size = 4
_this$ = -4						; size = 4
...
; 198  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$15198[ebp]
...
; 200  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	edx, DWORD PTR [ecx]
	add	edx, 4
	mov	DWORD PTR __Pnext$15199[ebp], edx

; 201  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:
	mov	eax, DWORD PTR __Pnext$15199[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$15199[ebp]
	mov	eax, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx], eax
$LN3@Orphan_all:
	mov	ecx, DWORD PTR __Pnext$15199[ebp]
	cmp	DWORD PTR [ecx], 0
...
PUBLIC	??_C@_1IC@HHCBALNB@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAV?$AAi?$AAc?$AAt?$AAo?$AAr?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAR?$AAa?$AAv?$AAe?$AAn?$AA?9?$AAI?$AAA@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IC@HHCBALNB@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAV?$AAi?$AAc?$AAt?$AAo?$AAr?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAR?$AAa?$AAv?$AAe?$AAn?$AA?9?$AAI?$AAA@
CONST	SEGMENT
??_C@_1IC@HHCBALNB@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAV?$AAi?$AAc?$AAt?$AAo?$AAr?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAR?$AAa?$AAv?$AAe?$AAn?$AA?9?$AAI?$AAA@ DB 'C'
	...
	DB	00H, 'e', 00H, 'n', 00H, '-', 00H, 'I', 00H, 'A', 00H, 'G', 00H
	DB	'\', 00H, 'R', 00H, 'a', 00H, 'v', 00H, 'e', 00H, 'n', 00H, 'I'
	DB	00H, 'A', 00H, 'G', 00H, 'v', 00H, '2', 00H, '\', 00H, 'C', 00H
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1IC@HHCBALNB@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAV?$AAi?$AAc?$AAt?$AAo?$AAr?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAR?$AAa?$AAv?$AAe?$AAn?$AA?9?$AAI?$AAA@
...
; 127  : 	return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR $T140039[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140039[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$134129[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$134129[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 147  : 	return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T140130[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140130[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
;	COMDAT xdata$x
; File c:\users\victor\desktop\raven-iag\raveniagv2\common\misc\stream_utility_functions.h
xdata$x	SEGMENT
...
__unwindfunclet$??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z$1:
	...
	and	eax, 1
	je	$LN5@ttos
	and	DWORD PTR $T140137[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@ttos:
	ret	0
...
; 434  : 			const _Nput& _Nput_fac = _USE(ios_base::getloc(), _Nput);
	...
	add	esp, 4
	mov	DWORD PTR __Nput_fac$136234[ebp], eax
...
$LN7@operator@4:
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T140219[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nput_fac$136234[ebp]
...
; 444  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T140220[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T140220[ebp]
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117951[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T140243[ebp], eax
	lea	ecx, DWORD PTR __Lock$117951[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T140243[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T140251[ebp]
	or	edx, 1
	mov	DWORD PTR $T140251[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 112  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117946[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T140278[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T140277[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T140277[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T140398[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140398[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T140398[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T140398[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T140428[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140428[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
tv195 = -32						; size = 4
$T140528 = -28						; size = 4
__Oldptr$136373 = -24					; size = 4
__Newptr$136372 = -20					; size = 4
__Inc$136367 = -16					; size = 4
__Newsize$136366 = -12					; size = 4
__Oldsize$136365 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T140528[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T140528[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$136365[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$136365[ebp]
	mov	DWORD PTR __Newsize$136366[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$136366[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$136366[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$136367[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$136367[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$136367[ebp]
	cmp	edx, DWORD PTR __Newsize$136366[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$136367[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$136367[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$136366[ebp]
	add	ecx, DWORD PTR __Inc$136367[ebp]
	mov	DWORD PTR __Newsize$136366[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$136372[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$136373[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$136365[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$136365[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$136373[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$136372[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$136372[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$136372[ebp]
	add	edx, DWORD PTR __Newsize$136366[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$136372[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$136373[ebp]
	add	eax, DWORD PTR __Newptr$136372[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$136365[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$136373[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T140578[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140578[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR [eax+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T140578[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T140578[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
tv91 = -148						; size = 4
$T140628 = -144						; size = 4
__Nul$136614 = -136					; size = 32
__Str$136612 = -96					; size = 32
__Str$136609 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$136609[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$136609[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T140628[ebp]
	or	ecx, 1
	mov	DWORD PTR $T140628[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$136609[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$136612[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 2
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T140628[ebp]
	or	edx, 1
	mov	DWORD PTR $T140628[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$136612[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$136614[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$136614[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T140628[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T140628[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T140628[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T140688[ebp], eax
	cmp	DWORD PTR $T140688[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T140688[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$136856[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$136856[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$136856[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$136856[ebp]
	add	ecx, DWORD PTR __Count$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$136856[ebp]
	push	edx
...
$T140719 = -64						; size = 4
$T140718 = -60						; size = 12
__Pfmod$134659 = -48					; size = 4
__Pf$134643 = -44					; size = 4
__Id$134642 = -40					; size = 4
__Psave$134630 = -32					; size = 4
__Lock$134629 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$134629[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$134630[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$134630[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$134630[ebp]
	mov	DWORD PTR __Pf$134643[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$134630[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T140718[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T140718[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$134630[ebp]
	mov	DWORD PTR __Pf$134643[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$134630[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$134630[ebp]
	mov	DWORD PTR __Pfmod$134659[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$134659[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$134643[ebp]
	mov	DWORD PTR $T140719[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$134629[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T140719[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117940[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T140748[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T140748[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T140755[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T140755[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T140751[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T140767[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T140767[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T140828[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T140828[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T140828[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T140828[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T140828[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T140828[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T140828[ebp+12]
...
$T140899 = -64						; size = 4
$T140898 = -60						; size = 12
__Pfmod$137367 = -48					; size = 4
__Pf$137356 = -44					; size = 4
__Id$137355 = -40					; size = 4
__Psave$137343 = -32					; size = 4
__Lock$137342 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$137342[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$137343[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$137355[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$137355[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$137356[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$137356[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$137343[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$137343[ebp]
	mov	DWORD PTR __Pf$137356[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$137343[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T140898[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T140898[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$137343[ebp]
	mov	DWORD PTR __Pf$137356[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$137343[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$137343[ebp]
	mov	DWORD PTR __Pfmod$137367[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$137367[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$137356[ebp]
	mov	DWORD PTR $T140899[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$137342[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T140899[ebp]
$LN8@use_facet@2:
...
; 1054 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T140918[ebp], eax
	push	1053					; 0000041dH
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T140918[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T140917[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T140917[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T140919[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T140923[ebp]
	or	eax, 1
	mov	DWORD PTR $T140923[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T140917[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T140916[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T140916[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T140923[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T140923[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T140919[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
$T140948 = -144						; size = 8
$T140945 = -136						; size = 4
__Fillcount$136718 = -132				; size = 4
$T136717 = -128						; size = 32
$T136715 = -96						; size = 32
__Str$136658 = -60					; size = 32
__Punct_fac$136651 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
; 1149 : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$136651[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T140945[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 1150 : 			_Mystr _Str;
	...
	lea	ecx, DWORD PTR __Str$136658[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
...
; 1152 : 				_Str.assign(_Punct_fac.truename());
	...
	lea	edx, DWORD PTR $T136715[ebp]
	push	edx
	mov	ecx, DWORD PTR __Punct_fac$136651[ebp]
...
$LN9@do_put:
	...
	mov	DWORD PTR __Fillcount$136718[ebp], edx
...
; 1162 : 				_Dest = _Rep(_Dest, _Fill, _Fillcount);
	...
	mov	eax, DWORD PTR __Fillcount$136718[ebp]
	push	eax
...
; 1163 : 				_Fillcount = 0;
	...
	mov	DWORD PTR __Fillcount$136718[ebp], 0
$LN1@do_put:
...
$LN18@do_put@6:
	...
	mov	BYTE PTR __Signed$136764[ebp], cl

; 1230 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$136764[ebp]
	test	edx, edx
...
; 1244 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$136764[ebp]
	test	ecx, ecx
...
$LN18@do_put@7:
	...
	mov	BYTE PTR __Signed$136787[ebp], cl

; 1271 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$136787[ebp]
	test	edx, edx
...
; 1285 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$136787[ebp]
	test	ecx, ecx
...
$T141063 = -168						; size = 8
$T141058 = -160						; size = 4
__Expoffset$136936 = -156				; size = 4
__Fracoffset$136929 = -152				; size = 4
__Adjustfield$ = -148					; size = 4
__Fillcount$ = -144					; size = 4
__Off$136909 = -140					; size = 4
__Pg$136908 = -136					; size = 4
...
; 1380 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$136908[ebp], eax
...
; 1381 : 			size_t _Off = _CSTD strcspn(&_Groupstring[0], &_Enders[0]);
	...
	call	_strcspn
	add	esp, 8
	mov	DWORD PTR __Off$136909[ebp], eax
$LN9@Fput:

; 1382 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1383 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$136908[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	SHORT $LN8@Fput
	mov	ecx, DWORD PTR __Pg$136908[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN8@Fput
	mov	eax, DWORD PTR __Pg$136908[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$136909[ebp]
...
; 1385 : 				_Groupstring.insert(_Off -= *_Pg, (size_t)1, '\0');
	...
	mov	edx, DWORD PTR __Off$136909[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$136909[ebp], edx
	push	0
	push	1
	mov	eax, DWORD PTR __Off$136909[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groupstring$[ebp]
	call	?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::insert
...
; 1427 : 			_Buf += _Fracoffset, _Count -= _Fracoffset;
	...
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Fracoffset$136929[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Fracoffset$136929[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN2@Fput:
...
; 1439 : 			_Buf += _Expoffset, _Count -= _Expoffset;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Expoffset$136936[ebp]
	mov	DWORD PTR __Buf$[ebp], ecx
	mov	edx, DWORD PTR __Count$[ebp]
	sub	edx, DWORD PTR __Expoffset$136936[ebp]
	mov	DWORD PTR __Count$[ebp], edx
$LN1@Fput:
...
__Off$136964 = -72					; size = 4
__Pg$136963 = -68					; size = 4
__Prefix$ = -64						; size = 4
__Grouping$ = -56					; size = 32
__Punct_fac$ = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
...
; 1489 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$136963[ebp], eax

; 1490 : 			size_t _Off = _Count;

	mov	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Off$136964[ebp], ecx
$LN9@Iput:

; 1491 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1492 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$136963[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	$LN10@Iput
	mov	ecx, DWORD PTR __Pg$136963[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN10@Iput
	mov	eax, DWORD PTR __Pg$136963[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$136964[ebp]
	sub	edx, DWORD PTR __Prefix$[ebp]
	cmp	ecx, edx
	jae	SHORT $LN10@Iput
...
; 1494 : 				_Off -= *_Pg;
	...
	mov	edx, DWORD PTR __Off$136964[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$136964[ebp], edx
$LN6@Iput:
...
; 1497 : 				_CRT_SECURE_MEMMOVE(&_Buf[_Off + 1], _Count + 1 - _Off,
	...
	mov	ecx, DWORD PTR __Count$[ebp]
	add	ecx, 1
	sub	ecx, DWORD PTR __Off$136964[ebp]
	push	ecx
	mov	edx, DWORD PTR __Buf$[ebp]
	add	edx, DWORD PTR __Off$136964[ebp]
	push	edx
	mov	eax, DWORD PTR __Count$[ebp]
	add	eax, 1
	sub	eax, DWORD PTR __Off$136964[ebp]
	push	eax
	mov	ecx, DWORD PTR __Off$136964[ebp]
	mov	edx, DWORD PTR __Buf$[ebp]
...
; 1500 : 				_Buf[_Off] = '\0', ++_Count;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Off$136964[ebp]
	mov	BYTE PTR [ecx], 0
	mov	edx, DWORD PTR __Count$[ebp]
	add	edx, 1
	mov	DWORD PTR __Count$[ebp], edx
...
; 1502 : 					++_Pg;	// not last group, advance
	...
	mov	edx, DWORD PTR __Pg$136963[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$136963[ebp], edx
$LN4@Iput:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T141138[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141138[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T141156 = -24						; size = 8
$T141155 = -16						; size = 8
__Groupsize$137071 = -8					; size = 4
__Pend$137069 = -4					; size = 4
_this$ = 8						; size = 4
___$ReturnUdt$ = 12					; size = 4
__Dest$ = 16						; size = 8
__Ptr$ = 24						; size = 4
...
; 1553 : 				(const char *)_CSTD memchr(_Ptr, '\0', _Count);
	...
	call	_memchr
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Pend$137069[ebp], eax

; 1554 : 			size_t _Groupsize = _Pend != 0 ? _Pend - _Ptr : _Count;

	cmp	DWORD PTR __Pend$137069[ebp], 0
	je	SHORT $LN8@Putgrouped
	mov	ecx, DWORD PTR __Pend$137069[ebp]
...
$LN9@Putgrouped:
	...
	mov	DWORD PTR __Groupsize$137071[ebp], eax

; 1555 : 
; 1556 : 			_Dest = _Putc(_Dest, _Ptr, _Groupsize);

	mov	ecx, DWORD PTR __Groupsize$137071[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp+4]
...
; 1557 : 			_Ptr += _Groupsize, _Count -= _Groupsize;
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Groupsize$137071[ebp]
	mov	DWORD PTR __Ptr$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Groupsize$137071[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
...
$LN5@sputc:
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Pninc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IAEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::_Pninc
	mov	DWORD PTR $T141163[ebp], eax
	mov	eax, DWORD PTR $T141163[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T141163[ebp]
	push	edx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR tv78[ebp], eax
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T141178[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141178[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T141185 = -64						; size = 4
$T141184 = -60						; size = 12
__Pfmod$137400 = -48					; size = 4
__Pf$137389 = -44					; size = 4
__Id$137388 = -40					; size = 4
__Psave$137376 = -32					; size = 4
__Lock$137375 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$137375[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$137376[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$137388[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$137388[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$137389[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$137389[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$137376[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$137376[ebp]
	mov	DWORD PTR __Pf$137389[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$137376[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$137376[ebp]
	mov	DWORD PTR __Pf$137389[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$137376[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$137376[ebp]
	mov	DWORD PTR __Pfmod$137400[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$137400[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$137389[ebp]
	mov	DWORD PTR $T141185[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$137375[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141185[ebp]
$LN8@use_facet@3:
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T141204[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T141204[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T141203[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141203[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T141205[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	edx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T141209[ebp]
	or	eax, 1
	mov	DWORD PTR $T141209[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141203[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T141202[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141202[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141209[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T141209[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141205[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T141235[ebp]
	or	edx, 1
	mov	DWORD PTR $T141235[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T141257[ebp]
	or	edx, 1
	mov	DWORD PTR $T141257[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	mov	DWORD PTR $T141279[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T141279[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T141279[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T141312[ebp], eax
	mov	edx, DWORD PTR $T141312[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$137623[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$137623[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$137623[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$137623[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
