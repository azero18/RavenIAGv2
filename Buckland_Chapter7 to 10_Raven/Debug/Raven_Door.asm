; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\Raven_Door.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_door.cpp
rdata$r	SEGMENT
...
; File c:\users\pedro\documents\github\raveniagv2\common\2d\vector2d.h
CONST	SEGMENT
...
; File c:\users\pedro\documents\github\raveniagv2\common\game\basegameentity.h
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\2d\wall2d.h
...
; 93   :     Clamp(m_dCurrentSize, 0, m_dSize);
	...
	mov	DWORD PTR $T148856[ebp], 0
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 136				; 00000088H
	push	edx
	lea	eax, DWORD PTR $T148856[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 132  :                 id) == m_Switches.end())
	...
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T148875[ebp]
	test	ecx, ecx
...
; 157  :   for (int i=0; i<num; ++i)
	...
	mov	DWORD PTR _i$139173[ebp], 0
	jmp	SHORT $LN3@Read
$LN2@Read:
	mov	edx, DWORD PTR _i$139173[ebp]
	add	edx, 1
	mov	DWORD PTR _i$139173[ebp], edx
$LN3@Read:
	mov	eax, DWORD PTR _i$139173[ebp]
...
; 161  :     m_Switches.push_back(trig);
	...
	mov	DWORD PTR $T148914[ebp], edx
	lea	eax, DWORD PTR $T148914[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 76					; 0000004cH
	call	?push_back@?$vector@IV?$allocator@I@std@@@std@@QAEXABI@Z ; std::vector<unsigned int,std::allocator<unsigned int> >::push_back
...
$T148932 = -76						; size = 8
$T148929 = -68						; size = 4
__Nget_fac$139894 = -64					; size = 4
__Tmp$139893 = -56					; size = 4
__Ok$ = -44						; size = 8
__State$ = -28						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
...
; 279  : 			long _Tmp = 0;
	...
	mov	DWORD PTR __Tmp$139893[ebp], 0

; 280  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);

	lea	ecx, DWORD PTR $T148929[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	add	esp, 4
	mov	DWORD PTR __Nget_fac$139894[ebp], eax
...
$LN9@operator@4:
	...
	lea	eax, DWORD PTR __Tmp$139893[ebp]
	push	eax
	...
	push	eax
	lea	ecx, DWORD PTR $T148933[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T148934[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$139894[ebp]
...
; 288  : 				|| _Tmp < INT_MIN || INT_MAX < _Tmp)
	...
	cmp	DWORD PTR __Tmp$139893[ebp], -2147483648 ; 80000000H
	jl	SHORT $LN2@operator@4
	cmp	DWORD PTR __Tmp$139893[ebp], 2147483647	; 7fffffffH
...
; 291  : 				_Val = _Tmp;
	...
	mov	eax, DWORD PTR __Tmp$139893[ebp]
	mov	DWORD PTR [edx], eax
$LN5@operator@4:
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T148968[ebp]
	or	edx, 1
	mov	DWORD PTR $T148968[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 417  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	call	??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ; std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char> > > >
	add	esp, 4
	mov	DWORD PTR __Nget_fac$140165[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T148989[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
$LN6@operator@5:
	...
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$140165[ebp]
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T149044[ebp]
	or	eax, 1
	mov	DWORD PTR $T149044[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@PAIPBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
	mov	eax, DWORD PTR $T149049[ebp]
	or	eax, 1
	mov	DWORD PTR $T149049[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 979  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 2
	mov	DWORD PTR __Idx$140689[ebp], eax
...
; 985  : 				this->_Myfirst[_Idx]);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR __Idx$140689[ebp]
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T149067[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T149066[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T149066[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$T149116 = -44						; size = 4
$T149115 = -40						; size = 4
__Meta$141434 = -32					; size = 4
__Ctype_fac$141430 = -24				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$141430[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR $T149115[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$141434[ebp], ecx
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T149116[ebp], edx
	lea	eax, DWORD PTR __Meta$141434[ebp]
	push	eax
	lea	ecx, DWORD PTR $T149116[ebp]
	push	ecx
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$141430[ebp]
...
$LN5@snextc:
	...
	mov	DWORD PTR $T149159[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T149160[ebp], eax
	lea	eax, DWORD PTR $T149159[ebp]
	push	eax
	lea	ecx, DWORD PTR $T149160[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
_TEXT	SEGMENT
__Size$142555 = -28					; size = 4
__Ptr$142548 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$142548[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$142548[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@IV?$allocator@I@std@@@std@@QBEIXZ ; std::vector<unsigned int,std::allocator<unsigned int> >::size
	mov	DWORD PTR __Size$142555[ebp], eax
...
; 770  : 			this->_Mylast = _Ptr + _Size;
	...
	mov	ecx, DWORD PTR __Size$142555[ebp]
	mov	edx, DWORD PTR __Ptr$142548[ebp]
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR __Ptr$142548[ebp]
	mov	DWORD PTR [edx+4], eax
$LN7@reserve:
...
$T149345 = -64						; size = 4
$T149344 = -60						; size = 12
__Pfmod$143733 = -48					; size = 4
__Pf$143717 = -44					; size = 4
__Id$143716 = -40					; size = 4
__Psave$143704 = -32					; size = 4
__Lock$143703 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$143703[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$143704[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$143704[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$143704[ebp]
	mov	DWORD PTR __Pf$143717[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$143704[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T149344[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T149344[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$143704[ebp]
	mov	DWORD PTR __Pf$143717[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$143704[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$143704[ebp]
	mov	DWORD PTR __Pfmod$143733[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$143733[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$143717[ebp]
	mov	DWORD PTR $T149345[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$143703[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T149345[ebp]
$LN8@use_facet:
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T149374[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T149374[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T149381[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T149381[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T149377[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T149393[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T149393[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T149455[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T149454[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T149454[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T149454[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T149454[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T149454[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T149454[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T149454[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T149454[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T149485[ebp], edx
	mov	eax, DWORD PTR $T149485[ebp]
	push	eax
...
; File c:\users\pedro\documents\github\raveniagv2\common\misc\stream_utility_functions.h
CONST	SEGMENT
...
PUBLIC	??_C@_1HO@CKKLKLPJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1HO@CKKLKLPJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
CONST	SEGMENT
??_C@_1HO@CKKLKLPJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ DB 'C'
...
$LN5@Clamp:
	push	175					; 000000afH
	push	OFFSET ??_C@_1HO@CKKLKLPJ@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
...
PUBLIC	??_C@_1IG@GCBEFDEK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
;	COMDAT ??_C@_1IG@GCBEFDEK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
; File c:\program files\microsoft visual studio 10.0\vc\include\algorithm
CONST	SEGMENT
??_C@_1IG@GCBEFDEK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 71   : 	{	// find first matching _Val
	...
	lea	eax, DWORD PTR __$EHRec$[ebp]
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR $T149526[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 72   : 	_DEBUG_RANGE(_First, _Last);

	push	72					; 00000048H
	push	OFFSET ??_C@_1IG@GCBEFDEK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
...
; 74   : 		_Find(_Unchecked(_First), _Unchecked(_Last), _Val)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	eax, DWORD PTR $T149526[ebp]
	or	eax, 1
	mov	DWORD PTR $T149526[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
...
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$6:
	...
	and	eax, 1
	je	$LN10@find
	and	DWORD PTR $T149526[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
$LN10@find:
	ret	0
...
$T149537 = -64						; size = 4
$T149536 = -60						; size = 12
__Pfmod$144366 = -48					; size = 4
__Pf$144355 = -44					; size = 4
__Id$144354 = -40					; size = 4
__Psave$144342 = -32					; size = 4
__Lock$144341 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144341[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144342[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$144354[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$144354[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$144355[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$144355[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144342[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144342[ebp]
	mov	DWORD PTR __Pf$144355[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$144342[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T149536[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T149536[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144342[ebp]
	mov	DWORD PTR __Pf$144355[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144342[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144342[ebp]
	mov	DWORD PTR __Pfmod$144366[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144366[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144355[ebp]
	mov	DWORD PTR $T149537[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144341[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T149537[ebp]
$LN8@use_facet@2:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T149566[ebp], al
	movzx	edx, BYTE PTR $T149566[ebp]
	push	edx
...
PUBLIC	??_C@_0EB@HMPBFFPA@c?3?2Program?5Files?2Microsoft?5Visua@ ; `string'
;	COMDAT ??_C@_0EB@HMPBFFPA@c?3?2Program?5Files?2Microsoft?5Visua@
; File c:\program files\microsoft visual studio 10.0\vc\include\xlocnum
CONST	SEGMENT
??_C@_0EB@HMPBFFPA@c?3?2Program?5Files?2Microsoft?5Visua@ DB 'c:\Program '
...
; 246  : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T149601[ebp], eax
	push	245					; 000000f5H
	push	OFFSET ??_C@_0EB@HMPBFFPA@c?3?2Program?5Files?2Microsoft?5Visua@
	mov	ecx, DWORD PTR $T149601[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T149600[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149600[ebp], 0
	...
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T149606[ebp]
	or	eax, 1
	mov	DWORD PTR $T149606[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T149600[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T149599[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T149599[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T149606[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T149606[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T149602[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T149619[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149619[ebp], 0
	...
	mov	ecx, DWORD PTR $T149619[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T149619[ebp]
...
PUBLIC	??_C@_1IC@NHICIJGH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
PUBLIC	__$ArrayPad$
EXTRN	__Stoulx:PROC
;	COMDAT ??_C@_1IC@NHICIJGH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IC@NHICIJGH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
$T149648 = -208						; size = 4
$T149647 = -204						; size = 4
__Ulo$142163 = -200					; size = 4
__Errno$142162 = -192					; size = 4
__Ep$142161 = -180					; size = 4
__Ac$142160 = -168					; size = 32
$T142149 = -132						; size = 32
$T142147 = -100						; size = 32
__Str$142146 = -64					; size = 32
__Punct_fac$142141 = -28				; size = 4
__Ans$ = -24						; size = 4
_this$ = -20						; size = 4
...
; 366  : 		_DEBUG_RANGE(_First, _Last);
	...
	push	366					; 0000016eH
	push	OFFSET ??_C@_1IC@NHICIJGH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
	mov	eax, DWORD PTR __Last$[ebp+4]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
	push	ecx
...
; 372  : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$142141[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T149647[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 373  : 			_Mystr _Str((_Mystrsize)1, (char_type)0);
	...
	push	0
	push	1
	lea	ecx, DWORD PTR __Str$142146[ebp]
...
; 374  : 			_Str += _Punct_fac.falsename();
	...
	push	ecx
	mov	ecx, DWORD PTR __Punct_fac$142141[ebp]
...
; 385  : 					_Iosbase.getloc()), &_Errno);
	...
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$142160[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	...
	add	esp, 24					; 00000018H
	push	eax
	lea	edx, DWORD PTR __Ep$142161[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$142160[ebp]
	push	eax
	call	__Stoulx
	add	esp, 16					; 00000010H
	mov	DWORD PTR __Ulo$142163[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T149648[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 386  : 			if (_Ep != _Ac && _Errno == 0 && _Ulo <= 1)
	...
	mov	ecx, DWORD PTR __Ep$142161[ebp]
	lea	edx, DWORD PTR __Ac$142160[ebp]
	cmp	ecx, edx
	je	SHORT $LN5@do_get
	cmp	DWORD PTR __Errno$142162[ebp], 0
	jne	SHORT $LN5@do_get
	cmp	DWORD PTR __Ulo$142163[ebp], 1
	ja	SHORT $LN5@do_get

; 387  : 				_Ans = _Ulo;

	mov	eax, DWORD PTR __Ulo$142163[ebp]
	mov	DWORD PTR __Ans$[ebp], eax
$LN5@do_get:
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$141133[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$141133[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$141133[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
tv75 = -137						; size = 1
$T149922 = -136						; size = 4
__Pg$142818 = -132					; size = 4
__Pe$142792 = -128					; size = 4
__Group$ = -124						; size = 4
...
; 672  : 		for (char *const _Pe = &_Ac[_MAX_INT_DIG - 1];
	...
	mov	DWORD PTR __Pe$142792[ebp], edx
...
$LN22@Getifld:
	mov	eax, DWORD PTR __Ptr$[ebp]
	cmp	eax, DWORD PTR __Pe$142792[ebp]
...
; 700  : 		for (const char *_Pg = _Grouping.c_str(); _Seendigit && 0 < _Group; )
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$142818[ebp], eax
$LN12@Getifld:
...
; 701  : 			if (*_Pg == CHAR_MAX)
	...
	mov	eax, DWORD PTR __Pg$142818[ebp]
...
; 707  : 				++_Pg;	// group size okay, advance to next test
	...
	mov	edx, DWORD PTR __Pg$142818[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$142818[ebp], edx
$LN9@Getifld:
...
$T149943 = -140						; size = 4
$T149940 = -136						; size = 4
__Pg$142891 = -132					; size = 4
__Group$142870 = -128					; size = 4
__Groups$142869 = -120					; size = 32
__Kseparator$142866 = -81				; size = 1
__Pten$ = -80						; size = 4
...
$LN73@Getffld:
	...
	mov	BYTE PTR __Kseparator$142866[ebp], al

; 759  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$142869[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 760  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$142870[ebp], 0
...
; 775  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$142870[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$142869[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 776  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$142870[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$142869[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 780  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$142866[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffld
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$142866[ebp]
	cmp	eax, ecx
...
; 785  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$142870[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$142870[ebp], edx
$LN44@Getffld:
...
; 787  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$142870[ebp], 0
...
; 794  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$142891[ebp], eax
$LN36@Getffld:
...
; 796  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$142891[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 799  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$142870[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$142870[ebp], eax
...
; 802  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$142891[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$142891[ebp], eax
$LN33@Getffld:
...
; 859  : 		return (_Pten);
	...
	mov	ecx, DWORD PTR __Pten$[ebp]
	mov	DWORD PTR $T149943[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T149943[ebp]
$LN70@Getffld:
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T149965[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149965[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T150001 = -148						; size = 4
$T149998 = -144						; size = 4
__Pg$143229 = -140					; size = 4
__Group$143209 = -136					; size = 4
__Groups$143208 = -128					; size = 32
__Kseparator$143205 = -89				; size = 1
__Phex$ = -88						; size = 4
...
$LN78@Getffldx:
	...
	mov	BYTE PTR __Kseparator$143205[ebp], cl

; 928  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$143208[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 929  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$143209[ebp], 0
...
; 944  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$143209[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$143208[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 945  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$143209[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$143208[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 949  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$143205[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffldx
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$143205[ebp]
	cmp	eax, ecx
...
; 954  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$143209[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$143209[ebp], edx
$LN44@Getffldx:
...
; 956  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$143209[ebp], 0
...
; 963  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$143229[ebp], eax
$LN36@Getffldx:
...
; 965  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$143229[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 968  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$143209[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$143209[ebp], eax
...
; 971  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$143229[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$143229[ebp], eax
$LN33@Getffldx:
...
; 1029 : 		return (0);	// power of 10 multiplier
	...
	mov	DWORD PTR $T150001[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T150001[ebp]
...
PUBLIC	??_C@_1IG@JPFHHEHK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IG@JPFHHEHK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IG@JPFHHEHK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 507  : 			_DEBUG_ERROR("istreambuf_iterator is not dereferencable");
	...
	push	507					; 000001fbH
	push	OFFSET ??_C@_1IG@JPFHHEHK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T150026[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150026[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 548  : 				_Strbuf->sbumpc()))
	...
	mov	ecx, DWORD PTR [ecx]
	call	?sbumpc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QAEHXZ ; std::basic_streambuf<char,std::char_traits<char> >::sbumpc
	mov	DWORD PTR $T150042[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150043[ebp], eax
	lea	edx, DWORD PTR $T150042[ebp]
	push	edx
	lea	eax, DWORD PTR $T150043[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 559  : 				_Meta = _Strbuf->sgetc()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150046[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150046[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$T150055 = -64						; size = 4
$T150054 = -60						; size = 12
__Pfmod$144570 = -48					; size = 4
__Pf$144559 = -44					; size = 4
__Id$144558 = -40					; size = 4
__Psave$144546 = -32					; size = 4
__Lock$144545 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144545[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144546[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$144558[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$144558[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$144559[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$144559[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144546[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144546[ebp]
	mov	DWORD PTR __Pf$144559[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$144546[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144546[ebp]
	mov	DWORD PTR __Pf$144559[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144546[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144546[ebp]
	mov	DWORD PTR __Pfmod$144570[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144570[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144559[ebp]
	mov	DWORD PTR $T150055[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144545[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150055[ebp]
$LN8@use_facet@3:
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	add	esp, 4
	mov	BYTE PTR $T150070[ebp], al
	movzx	ecx, BYTE PTR $T150070[ebp]
	push	ecx
...
tv144 = -88						; size = 4
$T150078 = -84						; size = 4
__Field$144626 = -80					; size = 4
__Off$144625 = -76					; size = 4
__Prefix$144624 = -69					; size = 1
__Column$144620 = -68					; size = 4
__Ans$ = -64						; size = 4
__Str$ = -56						; size = 32
__Off$144612 = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
...
; 546  : 	for (size_t _Off = 0; _Ptr[_Off] != (_Elem)0; ++_Off)
	...
	mov	DWORD PTR __Off$144612[ebp], 0
	jmp	SHORT $LN23@Getloctxt
$LN22@Getloctxt:
	mov	eax, DWORD PTR __Off$144612[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$144612[ebp], eax
$LN23@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$144612[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
...
; 547  : 		if (_Ptr[_Off] == _Ptr[0])
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$144612[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 552  : 	for (size_t _Column = 1; ; ++_Column, ++_First, _Ans = -1)
	...
	mov	DWORD PTR __Column$144620[ebp], 1
	jmp	SHORT $LN19@Getloctxt
$LN18@Getloctxt:
	mov	eax, DWORD PTR __Column$144620[ebp]
	add	eax, 1
	mov	DWORD PTR __Column$144620[ebp], eax
	mov	ecx, DWORD PTR __First$[ebp]
	call	??E?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAEAAV01@XZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator++
	mov	DWORD PTR __Ans$[ebp], -1
$LN19@Getloctxt:
...
; 554  : 		bool _Prefix = false;	// seen at least one valid prefix
	...
	mov	BYTE PTR __Prefix$144624[ebp], 0

; 555  : 		size_t _Off = 0;	// offset into fields

	mov	DWORD PTR __Off$144625[ebp], 0

; 556  : 		size_t _Field = 0;	// current field number

	mov	DWORD PTR __Field$144626[ebp], 0
...
$LN15@Getloctxt:
	mov	ecx, DWORD PTR __Field$144626[ebp]
	add	ecx, 1
	mov	DWORD PTR __Field$144626[ebp], ecx
$LN16@Getloctxt:
	mov	edx, DWORD PTR __Field$144626[ebp]
...
$LN12@Getloctxt:
	mov	eax, DWORD PTR __Off$144625[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$144625[ebp], eax
$LN13@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$144625[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	SHORT $LN11@Getloctxt
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$144625[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
...
; 564  : 				_Off += _Str[_Field];	// skip tested columns in field
	...
	mov	eax, DWORD PTR __Field$144626[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
	add	ecx, DWORD PTR __Off$144625[ebp]
	mov	DWORD PTR __Off$144625[ebp], ecx
...
; 566  : 				|| _Ptr[_Off] == (_Elem)0)
	...
	mov	edx, DWORD PTR __Off$144625[ebp]
	add	edx, DWORD PTR __Column$144620[ebp]
	mov	DWORD PTR __Off$144625[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$144625[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 569  : 					? _Column : 127);	// save skip count if small enough
	...
	cmp	DWORD PTR __Column$144620[ebp], 127	; 0000007fH
...
; 576  : 				_Prefix = true;	// still a valid prefix
	...
	mov	BYTE PTR __Prefix$144624[ebp], 1
$LN9@Getloctxt:
...
; 579  : 		if (!_Prefix || _First == _Last)
	...
	movzx	eax, BYTE PTR __Prefix$144624[ebp]
	test	eax, eax
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T150110[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EB@HMPBFFPA@c?3?2Program?5Files?2Microsoft?5Visua@
	mov	ecx, DWORD PTR $T150110[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T150109[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150109[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T150111[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	edx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T150115[ebp]
	or	eax, 1
	mov	DWORD PTR $T150115[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T150109[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T150108[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T150108[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T150115[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T150115[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T150111[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T150141[ebp]
	or	edx, 1
	mov	DWORD PTR $T150141[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$141112[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$141112[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T150199[ebp], eax
	mov	DWORD PTR $T150199[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T150199[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T150199[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 208  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Other>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T150271[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150271[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@AAI@std@@YAAAIAAI@Z		; std::forward<unsigned int &>
	add	esp, 4
	mov	edx, DWORD PTR $T150271[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T150271[ebp]
	mov	DWORD PTR tv73[ebp], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@II@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAI0@Z ; std::_Ptr_cat<unsigned int,unsigned int>
	add	esp, 8
	mov	BYTE PTR $T150294[ebp], al
	movzx	edx, BYTE PTR $T150294[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T150305[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150305[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABI@std@@YAABIABI@Z		; std::forward<unsigned int const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T150305[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T150305[ebp]
	mov	DWORD PTR tv73[ebp], eax
	jmp	SHORT $LN4@Construct
$LN3@Construct:
	mov	DWORD PTR tv73[ebp], 0
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$146033[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$146033[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$146033[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$146033[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
