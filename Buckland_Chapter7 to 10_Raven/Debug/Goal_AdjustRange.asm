; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\goals\Goal_AdjustRange.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\goals\goal_adjustrange.cpp
rdata$r	SEGMENT
...
; 259  :   Raven_Steering* const              GetSteering(){return m_pSteering;}
...
; 77   :   {throw std::runtime_error("Cannot add goals to atomic goals");}
	...
	lea	ecx, DWORD PTR $T143768[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T143768[ebp]
	push	eax
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$135636[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$135636[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$135636[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T143855[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T143855[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
