; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\armory\Projectile_Slug.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG137885 DB	'Slug_Mass', 00H
	ORG $+2
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG137884 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG137886 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG137887 DB	'Slug_Scale', 00H
	ORG $+1
$SG137888 DB	'Slug_Damage', 00H
$SG137889 DB	'Slug_Persistance', 00H
CONST	ENDS
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\armory\projectile_slug.cpp
rdata$r	SEGMENT
...
; 32   : {
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG137886
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG137887
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\armory\raven_projectile.h
rdata$r	SEGMENT
...
; File c:\users\pedro\documents\github\raveniagv2\common\time\crudetimer.h
CONST	SEGMENT
...
; 201  :   Vector2D      Facing()const{return m_vFacing;}
...
; 258  :   Raven_Game* const                  GetWorld(){return m_pWorld;} 
...
$T147765 = -108						; size = 16
$T147764 = -92						; size = 16
_accel$137908 = -72					; size = 16
_sf$137905 = -48					; size = 16
_DesiredVelocity$137900 = -24				; size = 16
_this$ = -4						; size = 4
...
; 44   :     Vector2D DesiredVelocity = Vec2DNormalize(m_vTarget - Pos()) * MaxSpeed();
	...
	add	esp, 8
	push	eax
	lea	edx, DWORD PTR _DesiredVelocity$137900[ebp]
	push	edx
...
; 46   :     Vector2D sf = DesiredVelocity - Velocity();
	...
	lea	eax, DWORD PTR $T147767[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
	push	eax
	lea	ecx, DWORD PTR _DesiredVelocity$137900[ebp]
	push	ecx
	lea	edx, DWORD PTR _sf$137905[ebp]
	push	edx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 49   :     Vector2D accel = sf / m_dMass;
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _sf$137905[ebp]
	push	ecx
	lea	edx, DWORD PTR _accel$137908[ebp]
	push	edx
...
; 51   :     m_vVelocity += accel;
	...
	lea	eax, DWORD PTR _accel$137908[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 64					; 00000040H
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\armory\projectile_slug.h
_TEXT	ENDS
...
$LN3@TestForImp:
	...
	mov	BYTE PTR $T147820[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T147821[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T147820[ebp]
	test	ecx, ecx
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$143492[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143492[ebp]
	push	edx
	lea	eax, DWORD PTR $T143494[ebp]
	push	eax
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$140068[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140068[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140068[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T148125[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T148125[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140047[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140047[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T148189[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148189[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T148189[ebp]
	and	eax, 1
	je	$LN5@operator@8
	and	DWORD PTR $T148189[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@8:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$143509[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143509[ebp]
	push	edx
	...
	push	edx
	lea	ecx, DWORD PTR $T148239[ebp]
	call	??0runtime_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T148239[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T143510[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
;	COMDAT xdata$x
; File c:\users\pedro\documents\github\raveniagv2\common\2d\wallintersectiontests.h
xdata$x	SEGMENT
...
$T148254 = -88						; size = 12
$T148253 = -73						; size = 1
_point$143702 = -68					; size = 16
_dist$143701 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
$LN6@FindCloses:
	...
	movzx	edx, BYTE PTR $T148253[ebp]
	test	edx, edx
	je	$LN4@FindCloses
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$143701[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$143702[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$143702[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$143701[ebp]
	push	ecx
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$143701[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$143701[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$143702[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$143702[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$143702[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$143702[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T148257[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T148257[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T148258[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T148258[ebp]
$LN7@FindCloses:
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$144383[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$144383[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 787  : 		return (const_iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T148347[ebp]
	or	eax, 1
	mov	DWORD PTR $T148347[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@PAPAVWall2D@@PBU_Container_base12@1@@Z ; std::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >::_Vector_const_iterator<std::_Vector_val<Wall2D *,std::allocator<Wall2D *> > >
	mov	eax, DWORD PTR $T148352[ebp]
	or	eax, 1
	mov	DWORD PTR $T148352[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T148357[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148357[ebp], 0
