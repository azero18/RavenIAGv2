; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\goals\AttackTargetGoal_Evaluator.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\goals\attacktargetgoal_evaluator.cpp
CONST	SEGMENT
...
; 25   :      const double Tweaker = 1.0;
	...
	fld1
	fstp	QWORD PTR _Tweaker$133861[ebp]
...
; 29   :                     Raven_Feature::TotalWeaponStrength(pBot);
	...
	add	esp, 4
	fmul	QWORD PTR _Tweaker$133861[ebp]
...
; 238  :   Raven_TargetingSystem* const       GetTargetSys(){return m_pTargSys;}
...
; 49   :   gdi->TextAtPos(Position, "AT: " + ttos(CalculateDesirability(pBot), 2));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	fstp	QWORD PTR $T142973[ebp]
	push	2
	lea	ecx, DWORD PTR $T142973[ebp]
	push	ecx
	lea	edx, DWORD PTR $T133877[ebp]
	push	edx
	...
	push	ecx
	push	OFFSET $SG133879
	lea	edx, DWORD PTR $T133878[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR $T133878[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T133877[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 52   :   std::string s = ttos(Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::TotalWeaponStrength(pBot));
	...
	call	?TotalWeaponStrength@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::TotalWeaponStrength
	add	esp, 4
	fstp	QWORD PTR $T142974[ebp]
	mov	eax, DWORD PTR _pBot$[ebp]
	push	eax
	call	?Health@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::Health
	add	esp, 4
	fstp	QWORD PTR $T142975[ebp]
	push	2
	lea	ecx, DWORD PTR $T142974[ebp]
	push	ecx
	lea	edx, DWORD PTR $T133885[ebp]
	push	edx
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	push	ecx
	push	OFFSET $SG133951
	push	2
	lea	edx, DWORD PTR $T142975[ebp]
	push	edx
	lea	eax, DWORD PTR $T133882[ebp]
	push	eax
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	lea	ecx, DWORD PTR $T133883[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 7
	lea	ecx, DWORD PTR $T133882[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T133885[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$135486[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$135486[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$135486[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T143051[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T143051[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 127  : 	return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR $T143065[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143065[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$135465[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$135465[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 147  : 	return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143156[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143156[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 27   :   return buffer.str();
	...
	mov	eax, DWORD PTR $T143163[ebp]
	or	eax, 1
	mov	DWORD PTR $T143163[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR _buffer$[ebp]
...
__unwindfunclet$??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z$1:
	...
	and	eax, 1
	je	$LN5@ttos
	and	DWORD PTR $T143163[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@ttos:
	ret	0
...
; 115  : 		return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143181[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143181[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 117  : 		return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T143181[ebp]
	or	eax, 1
	mov	DWORD PTR $T143181[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
$LN4@operator@2:
...
; 434  : 			const _Nput& _Nput_fac = _USE(ios_base::getloc(), _Nput);
	...
	add	esp, 4
	mov	DWORD PTR __Nput_fac$139122[ebp], eax
...
$LN7@operator@4:
	...
	push	eax
	mov	ecx, DWORD PTR __Nput_fac$139122[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T143406[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T143406[ebp], 0
	...
	mov	ecx, DWORD PTR $T143406[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T143406[ebp]
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T143424[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143424[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T143424[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T143424[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T143454[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143454[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	lea	ecx, DWORD PTR $T143511[ebp]
	push	ecx
	lea	edx, DWORD PTR $T143512[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
tv195 = -32						; size = 4
$T143554 = -28						; size = 4
__Oldptr$139275 = -24					; size = 4
__Newptr$139274 = -20					; size = 4
__Inc$139269 = -16					; size = 4
__Newsize$139268 = -12					; size = 4
__Oldsize$139267 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$139267[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$139267[ebp]
	mov	DWORD PTR __Newsize$139268[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$139268[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$139268[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$139269[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$139269[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$139269[ebp]
	cmp	edx, DWORD PTR __Newsize$139268[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$139269[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$139269[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$139268[ebp]
	add	ecx, DWORD PTR __Inc$139269[ebp]
	mov	DWORD PTR __Newsize$139268[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$139274[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$139275[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$139267[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$139267[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$139275[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$139274[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$139274[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$139274[ebp]
	add	edx, DWORD PTR __Newsize$139268[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$139274[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$139275[ebp]
	add	eax, DWORD PTR __Newptr$139274[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$139267[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$139275[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T143576[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T143576[ebp]
	push	ecx
...
; 199  : 			if (!_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T143577[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T143577[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
tv91 = -148						; size = 4
$T143654 = -144						; size = 4
__Nul$139502 = -136					; size = 32
__Str$139500 = -96					; size = 32
__Str$139497 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$139497[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$139497[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143654[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143654[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$139497[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$139500[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 2
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$139502[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$139502[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143654[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	...
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T143654[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T143705[ebp], eax
	cmp	DWORD PTR $T143705[ebp], 0
	je	SHORT $LN3@Init
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$139746[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$139746[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$139746[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$139746[ebp]
	add	ecx, DWORD PTR __Count$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$139746[ebp]
	push	edx
...
$T143747 = -64						; size = 4
$T143746 = -60						; size = 12
__Pfmod$137274 = -48					; size = 4
__Pf$137258 = -44					; size = 4
__Id$137257 = -40					; size = 4
__Psave$137245 = -32					; size = 4
__Lock$137244 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$137244[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$137245[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$137245[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$137245[ebp]
	mov	DWORD PTR __Pf$137258[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$137245[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T143746[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T143746[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$137245[ebp]
	mov	DWORD PTR __Pf$137258[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$137245[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$137245[ebp]
	mov	DWORD PTR __Pfmod$137274[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$137274[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$137258[ebp]
	mov	DWORD PTR $T143747[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$137244[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T143747[ebp]
$LN8@use_facet:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T143783[ebp]
	or	eax, 1
	mov	DWORD PTR $T143783[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T143777[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T143776[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T143776[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T143783[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T143783[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T143779[ebp]
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T143857[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T143856[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T143856[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T143856[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T143856[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T143856[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T143856[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T143856[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T143856[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T143887[ebp], edx
	mov	eax, DWORD PTR $T143887[ebp]
	push	eax
...
$T143925 = -64						; size = 4
$T143924 = -60						; size = 12
__Pfmod$140279 = -48					; size = 4
__Pf$140268 = -44					; size = 4
__Id$140267 = -40					; size = 4
__Psave$140255 = -32					; size = 4
__Lock$140254 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$140254[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$140255[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$140267[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$140267[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$140268[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$140268[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$140255[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$140255[ebp]
	mov	DWORD PTR __Pf$140268[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$140255[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T143924[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T143924[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$140255[ebp]
	mov	DWORD PTR __Pf$140268[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$140255[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$140255[ebp]
	mov	DWORD PTR __Pfmod$140279[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$140279[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$140268[ebp]
	mov	DWORD PTR $T143925[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$140254[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T143925[ebp]
$LN8@use_facet@2:
...
; 1054 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T143944[ebp], eax
	push	1053					; 0000041dH
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T143944[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T143943[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T143945[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T143949[ebp]
	or	eax, 1
	mov	DWORD PTR $T143949[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T143942[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T143942[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T143949[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T143949[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T143945[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
$T143974 = -144						; size = 8
$T143971 = -136						; size = 4
__Fillcount$139606 = -132				; size = 4
$T139605 = -128						; size = 32
$T139603 = -96						; size = 32
__Str$139546 = -60					; size = 32
__Punct_fac$139539 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
; 1149 : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$139539[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T143971[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 1150 : 			_Mystr _Str;
	...
	lea	ecx, DWORD PTR __Str$139546[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
...
; 1152 : 				_Str.assign(_Punct_fac.truename());
	...
	lea	edx, DWORD PTR $T139603[ebp]
	push	edx
	mov	ecx, DWORD PTR __Punct_fac$139539[ebp]
...
$LN9@do_put:
	...
	mov	DWORD PTR __Fillcount$139606[ebp], edx
...
; 1162 : 				_Dest = _Rep(_Dest, _Fill, _Fillcount);
	...
	mov	eax, DWORD PTR __Fillcount$139606[ebp]
	push	eax
...
; 1163 : 				_Fillcount = 0;
	...
	mov	DWORD PTR __Fillcount$139606[ebp], 0
$LN1@do_put:
...
$LN18@do_put@6:
	...
	mov	BYTE PTR __Signed$139652[ebp], cl

; 1230 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$139652[ebp]
	test	edx, edx
...
; 1244 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$139652[ebp]
	test	ecx, ecx
...
$LN18@do_put@7:
	...
	mov	BYTE PTR __Signed$139675[ebp], cl

; 1271 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$139675[ebp]
	test	edx, edx
...
; 1285 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$139675[ebp]
	test	ecx, ecx
...
$T144089 = -168						; size = 8
$T144084 = -160						; size = 4
__Expoffset$139826 = -156				; size = 4
__Fracoffset$139819 = -152				; size = 4
__Adjustfield$ = -148					; size = 4
__Fillcount$ = -144					; size = 4
__Off$139799 = -140					; size = 4
__Pg$139798 = -136					; size = 4
...
; 1380 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$139798[ebp], eax
...
; 1381 : 			size_t _Off = _CSTD strcspn(&_Groupstring[0], &_Enders[0]);
	...
	call	_strcspn
	add	esp, 8
	mov	DWORD PTR __Off$139799[ebp], eax
$LN9@Fput:

; 1382 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1383 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$139798[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	SHORT $LN8@Fput
	mov	ecx, DWORD PTR __Pg$139798[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN8@Fput
	mov	eax, DWORD PTR __Pg$139798[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$139799[ebp]
...
; 1385 : 				_Groupstring.insert(_Off -= *_Pg, (size_t)1, '\0');
	...
	mov	edx, DWORD PTR __Off$139799[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$139799[ebp], edx
	push	0
	push	1
	mov	eax, DWORD PTR __Off$139799[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groupstring$[ebp]
	call	?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::insert
...
; 1427 : 			_Buf += _Fracoffset, _Count -= _Fracoffset;
	...
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Fracoffset$139819[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Fracoffset$139819[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN2@Fput:
...
; 1439 : 			_Buf += _Expoffset, _Count -= _Expoffset;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Expoffset$139826[ebp]
	mov	DWORD PTR __Buf$[ebp], ecx
	mov	edx, DWORD PTR __Count$[ebp]
	sub	edx, DWORD PTR __Expoffset$139826[ebp]
	mov	DWORD PTR __Count$[ebp], edx
$LN1@Fput:
...
__Off$139854 = -72					; size = 4
__Pg$139853 = -68					; size = 4
__Prefix$ = -64						; size = 4
__Grouping$ = -56					; size = 32
__Punct_fac$ = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
...
; 1489 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$139853[ebp], eax

; 1490 : 			size_t _Off = _Count;

	mov	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Off$139854[ebp], ecx
$LN9@Iput:

; 1491 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1492 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$139853[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	$LN10@Iput
	mov	ecx, DWORD PTR __Pg$139853[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN10@Iput
	mov	eax, DWORD PTR __Pg$139853[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$139854[ebp]
	sub	edx, DWORD PTR __Prefix$[ebp]
	cmp	ecx, edx
	jae	SHORT $LN10@Iput
...
; 1494 : 				_Off -= *_Pg;
	...
	mov	edx, DWORD PTR __Off$139854[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$139854[ebp], edx
$LN6@Iput:
...
; 1497 : 				_CRT_SECURE_MEMMOVE(&_Buf[_Off + 1], _Count + 1 - _Off,
	...
	mov	ecx, DWORD PTR __Count$[ebp]
	add	ecx, 1
	sub	ecx, DWORD PTR __Off$139854[ebp]
	push	ecx
	mov	edx, DWORD PTR __Buf$[ebp]
	add	edx, DWORD PTR __Off$139854[ebp]
	push	edx
	mov	eax, DWORD PTR __Count$[ebp]
	add	eax, 1
	sub	eax, DWORD PTR __Off$139854[ebp]
	push	eax
	mov	ecx, DWORD PTR __Off$139854[ebp]
	mov	edx, DWORD PTR __Buf$[ebp]
...
; 1500 : 				_Buf[_Off] = '\0', ++_Count;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Off$139854[ebp]
	mov	BYTE PTR [ecx], 0
	mov	edx, DWORD PTR __Count$[ebp]
	add	edx, 1
	mov	DWORD PTR __Count$[ebp], edx
...
; 1502 : 					++_Pg;	// not last group, advance
	...
	mov	edx, DWORD PTR __Pg$139853[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$139853[ebp], edx
$LN4@Iput:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T144166[ebp]
	or	ecx, 1
	mov	DWORD PTR $T144166[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T144171[ebp]
	or	ecx, 1
	mov	DWORD PTR $T144171[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T144182 = -24						; size = 8
$T144181 = -16						; size = 8
__Groupsize$139954 = -8					; size = 4
__Pend$139952 = -4					; size = 4
_this$ = 8						; size = 4
___$ReturnUdt$ = 12					; size = 4
__Dest$ = 16						; size = 8
__Ptr$ = 24						; size = 4
...
; 1553 : 				(const char *)_CSTD memchr(_Ptr, '\0', _Count);
	...
	call	_memchr
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Pend$139952[ebp], eax

; 1554 : 			size_t _Groupsize = _Pend != 0 ? _Pend - _Ptr : _Count;

	cmp	DWORD PTR __Pend$139952[ebp], 0
	je	SHORT $LN8@Putgrouped
	mov	ecx, DWORD PTR __Pend$139952[ebp]
...
$LN9@Putgrouped:
	...
	mov	DWORD PTR __Groupsize$139954[ebp], eax

; 1555 : 
; 1556 : 			_Dest = _Putc(_Dest, _Ptr, _Groupsize);

	mov	ecx, DWORD PTR __Groupsize$139954[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp+4]
...
; 1557 : 			_Ptr += _Groupsize, _Count -= _Groupsize;
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Groupsize$139954[ebp]
	mov	DWORD PTR __Ptr$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Groupsize$139954[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
...
; 625  : 				_Strbuf->sputc(_Right)))
	...
	mov	DWORD PTR $T144185[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T144186[ebp], eax
...
$LN5@sputc:
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Pninc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IAEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::_Pninc
	mov	DWORD PTR $T144189[ebp], eax
	mov	eax, DWORD PTR $T144189[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T144189[ebp]
	push	edx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR tv78[ebp], eax
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T144204[ebp]
	or	ecx, 1
	mov	DWORD PTR $T144204[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T144211 = -64						; size = 4
$T144210 = -60						; size = 12
__Pfmod$140312 = -48					; size = 4
__Pf$140301 = -44					; size = 4
__Id$140300 = -40					; size = 4
__Psave$140288 = -32					; size = 4
__Lock$140287 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$140287[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$140288[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$140300[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$140300[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$140301[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$140301[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$140288[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$140288[ebp]
	mov	DWORD PTR __Pf$140301[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$140288[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$140288[ebp]
	mov	DWORD PTR __Pf$140301[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$140288[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$140288[ebp]
	mov	DWORD PTR __Pfmod$140312[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$140312[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$140301[ebp]
	mov	DWORD PTR $T144211[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$140287[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T144211[ebp]
$LN8@use_facet@3:
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T144230[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@CBNPAENE@C?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T144230[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T144229[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144229[ebp], 0
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T144235[ebp]
	or	eax, 1
	mov	DWORD PTR $T144235[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T144229[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T144228[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T144228[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T144235[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T144235[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T144231[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T144261[ebp]
	or	edx, 1
	mov	DWORD PTR $T144261[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 179  : 		return (string_type(_Falsename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T144278[ebp]
	or	edx, 1
	mov	DWORD PTR $T144278[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T144305[ebp], eax
	mov	DWORD PTR $T144305[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T144305[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T144305[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T144338[ebp], eax
	mov	edx, DWORD PTR $T144338[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$140539[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$140539[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$140539[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$140539[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
