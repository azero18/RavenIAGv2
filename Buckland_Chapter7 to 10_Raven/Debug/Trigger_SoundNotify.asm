; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\triggers\Trigger_SoundNotify.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG135022 DB	'Bot_TriggerUpdateFreq', 00H
CONST	ENDS
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\triggers\trigger_soundnotify.cpp
rdata$r	SEGMENT
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\triggers\trigger_soundnotify.h
_TEXT	ENDS
...
; File c:\users\pedro\documents\github\raveniagv2\common\triggers\trigger_limitedlifetime.h
rdata$r	SEGMENT
...
; 67   :   virtual ~Trigger(){delete m_pRegionOfInfluence;}
	...
	mov	DWORD PTR $T144456[ebp], edx
	mov	eax, DWORD PTR $T144456[ebp]
	mov	DWORD PTR $T144455[ebp], eax
	cmp	DWORD PTR $T144455[ebp], 0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$140243[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$140243[ebp]
	push	edx
	lea	eax, DWORD PTR $T140245[ebp]
	push	eax
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$136931[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$136931[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$136931[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$136910[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$136910[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T144655[ebp]
	or	ecx, 1
	mov	DWORD PTR $T144655[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T144655[ebp]
	and	eax, 1
	je	$LN5@operator
	and	DWORD PTR $T144655[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator:
	ret	0
...
; 91   :   if (m_pRegionOfInfluence) delete m_pRegionOfInfluence;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+64]
	mov	DWORD PTR $T144707[ebp], edx
	mov	eax, DWORD PTR $T144707[ebp]
	mov	DWORD PTR $T144706[ebp], eax
	cmp	DWORD PTR $T144706[ebp], 0
	je	SHORT $LN4@AddCircula
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T144706[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T144706[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
...
; 93   :   m_pRegionOfInfluence = new TriggerRegion_Circle(center, radius);
	...
	add	esp, 4
	mov	DWORD PTR $T144711[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144711[ebp], 0
...
$LN7@AddCircula:
	...
	mov	DWORD PTR $T144710[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T144710[ebp]
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$141186[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$141186[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T144781[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144781[ebp], 0
	...
	mov	ecx, DWORD PTR $T144781[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T144781[ebp]
