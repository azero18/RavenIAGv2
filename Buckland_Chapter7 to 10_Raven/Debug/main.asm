; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Pedro\Documents\GitHub\RavenIAGv2\Buckland_Chapter7 to 10_Raven\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG140255		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG140257		; g_szWindowClassName
_DATA	ENDS
CONST	SEGMENT
...
$SG140318 DB	'map', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG140255 DB	'Raven', 00H
$SG140330 DB	00H
	ORG $+1
$SG140257 DB	'MyWindowClass', 00H
	ORG $+2
$SG140319 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG140329 DB	'Filename: ', 00H
	ORG $+1
$SG140383 DB	'Error', 00H
	ORG $+2
$SG140384 DB	'Registration Failed!', 00H
	ORG $+3
$SG140387 DB	'Error!', 00H
	ORG $+1
$SG140388 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
EXTRN	?AddBots@Raven_Game@@QAEXII@Z:PROC		; Raven_Game::AddBots
...
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\main.cpp
_BSS	SEGMENT
...
$T150102 = -224						; size = 4
$T150101 = -220						; size = 4
_hdc$140358 = -216					; size = 4
_ps$140350 = -208					; size = 64
$T140332 = -140						; size = 32
$T140317 = -108						; size = 32
$T140316 = -76						; size = 32
_hdc$140286 = -44					; size = 4
_rect$140284 = -36					; size = 16
...
; 69   : 			   GetClientRect(hwnd, &rect);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _rect$140284[ebp]
	push	ecx
...
; 84   :          HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$140286[ebp], eax
...
; 88   :                                           cyClient);
	...
	push	ecx
	mov	edx, DWORD PTR _hdc$140286[ebp]
	push	edx
...
; 98   :          g_pRaven = new Raven_Game();
	...
	cmp	DWORD PTR $T150102[ebp], 0
	je	SHORT $LN44@WindowProc
	mov	ecx, DWORD PTR $T150102[ebp]
...
$LN45@WindowProc:
	...
	mov	DWORD PTR $T150101[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T150101[ebp]
...
; 166  :          case VK_UP:
; 167  : 
; 168  :            g_pRaven->AddBots(1,0); break;

	push	0
	push	1
	mov	ecx, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	call	?AddBots@Raven_Game@@QAEXII@Z		; Raven_Game::AddBots
	jmp	SHORT $LN36@WindowProc
$LN27@WindowProc:
...
; 198  :      switch(wParam)
	...
	cmp	DWORD PTR tv207[ebp], 19		; 00000013H
	ja	$LN3@WindowProc
...
; 204  :           FileOpenDlg(hwnd, szFileName, szTitleName, "Raven map file (*.map)", "map");
	...
	lea	ecx, DWORD PTR $T140316[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	push	OFFSET $SG140319
	lea	ecx, DWORD PTR $T140317[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR $T140316[ebp]
	push	ecx
	lea	edx, DWORD PTR $T140317[ebp]
	push	edx
...
; 206  :           debug_con << "Filename: " << szTitleName << "";
	...
	push	OFFSET $SG140330
	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	push	OFFSET $SG140329
...
; 220  : 
; 221  : 	  //NEW: adicionar novo tipo de bot
; 222  : 	  case IDM_GAME_ADDBOT2:
; 223  : 
; 224  : 		  g_pRaven->AddBots(1,1);
...
; 227  : 
; 228  :       case IDM_GAME_REMOVEBOT:
; 229  :           
; 230  :           g_pRaven->RemoveBot();
...
; 233  : 
; 234  :       case IDM_GAME_PAUSE:
; 235  :           
; 236  :           g_pRaven->TogglePause();
...
; 240  : 
; 241  : 
; 242  :       case IDM_NAVIGATION_SHOW_NAVGRAPH:
; 243  : 
; 244  :         UserOptions->m_bShowGraph = !UserOptions->m_bShowGraph;
...
; 245  : 
; 246  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_NAVGRAPH, UserOptions->m_bShowGraph);
...
; 249  :         
; 250  :       case IDM_NAVIGATION_SHOW_PATH:
; 251  : 
; 252  :         UserOptions->m_bShowPathOfSelectedBot = !UserOptions->m_bShowPathOfSelectedBot;
...
; 253  : 
; 254  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_PATH, UserOptions->m_bShowPathOfSelectedBot);
...
; 257  : 
; 258  :       case IDM_NAVIGATION_SHOW_INDICES:
; 259  : 
; 260  :         UserOptions->m_bShowNodeIndices = !UserOptions->m_bShowNodeIndices;
...
; 261  : 
; 262  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SHOW_INDICES, UserOptions->m_bShowNodeIndices);
...
; 265  : 
; 266  :       case IDM_NAVIGATION_SMOOTH_PATHS_QUICK:
; 267  : 
; 268  :         UserOptions->m_bSmoothPathsQuick = !UserOptions->m_bSmoothPathsQuick;
...
; 269  :         UserOptions->m_bSmoothPathsPrecise = false;

	call	?Instance@Raven_UserOptions@@SAPAV1@XZ	; Raven_UserOptions::Instance
	mov	BYTE PTR [eax+10], 0

; 270  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_PRECISE, UserOptions->m_bSmoothPathsPrecise);
...
; 271  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_QUICK, UserOptions->m_bSmoothPathsQuick);
...
; 274  : 
; 275  :       case IDM_NAVIGATION_SMOOTH_PATHS_PRECISE:
; 276  : 
; 277  :         UserOptions->m_bSmoothPathsPrecise = !UserOptions->m_bSmoothPathsPrecise;
...
; 278  :         UserOptions->m_bSmoothPathsQuick = false;

	call	?Instance@Raven_UserOptions@@SAPAV1@XZ	; Raven_UserOptions::Instance
	mov	BYTE PTR [eax+9], 0

; 279  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_QUICK, UserOptions->m_bSmoothPathsQuick);
...
; 280  :         CheckMenuItemAppropriately(hwnd, IDM_NAVIGATION_SMOOTH_PATHS_PRECISE, UserOptions->m_bSmoothPathsPrecise);
...
; 283  : 
; 284  :       case IDM_BOTS_SHOW_IDS:
; 285  : 
; 286  :         UserOptions->m_bShowBotIDs = !UserOptions->m_bShowBotIDs;
...
; 287  : 
; 288  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_IDS, UserOptions->m_bShowBotIDs);
...
; 291  : 
; 292  :       case IDM_BOTS_SHOW_HEALTH:
; 293  : 
; 294  :         UserOptions->m_bShowBotHealth = !UserOptions->m_bShowBotHealth;
...
; 295  :         
; 296  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_HEALTH, UserOptions->m_bShowBotHealth);
...
; 299  : 
; 300  :       case IDM_BOTS_SHOW_TARGET:
; 301  : 
; 302  :         UserOptions->m_bShowTargetOfSelectedBot = !UserOptions->m_bShowTargetOfSelectedBot;
...
; 303  :         
; 304  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_TARGET, UserOptions->m_bShowTargetOfSelectedBot);
...
; 307  : 
; 308  :       case IDM_BOTS_SHOW_SENSED:
; 309  : 
; 310  :         UserOptions->m_bShowOpponentsSensedBySelectedBot = !UserOptions->m_bShowOpponentsSensedBySelectedBot;
...
; 311  :         
; 312  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_SENSED, UserOptions->m_bShowOpponentsSensedBySelectedBot);
...
; 315  : 
; 316  : 
; 317  :       case IDM_BOTS_SHOW_FOV:
; 318  : 
; 319  :         UserOptions->m_bOnlyShowBotsInTargetsFOV = !UserOptions->m_bOnlyShowBotsInTargetsFOV;
...
; 320  :         
; 321  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_FOV, UserOptions->m_bOnlyShowBotsInTargetsFOV);
...
; 324  : 
; 325  :       case IDM_BOTS_SHOW_SCORES:
; 326  : 
; 327  :         UserOptions->m_bShowScore = !UserOptions->m_bShowScore;
...
; 328  :         
; 329  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_SCORES, UserOptions->m_bShowScore);
...
; 332  : 
; 333  :       case IDM_BOTS_SHOW_GOAL_Q:
; 334  : 
; 335  :         UserOptions->m_bShowGoalsOfSelectedBot = !UserOptions->m_bShowGoalsOfSelectedBot;
...
; 336  :         
; 337  :         CheckMenuItemAppropriately(hwnd, IDM_BOTS_SHOW_GOAL_Q, UserOptions->m_bShowGoalsOfSelectedBot);
...
; 350  :          BeginPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$140350[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 351  : 
; 352  :         //fill our backbuffer with white
; 353  :          BitBlt(hdcBackBuffer,
; 354  :                 0,
; 355  :                 0,
; 356  :                 cxClient,
; 357  :                 cyClient,
...
; 362  :           
; 363  :          
; 364  :          gdi->StartDrawing(hdcBackBuffer);
...
; 367  : 
; 368  :          gdi->StopDrawing(hdcBackBuffer);
...
; 369  : 
; 370  : 
; 371  :          //now blit backbuffer to front
; 372  : 			   BitBlt(ps.hdc, 0, 0, cxClient, cyClient, hdcBackBuffer, 0, 0, SRCCOPY); 
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _ps$140350[ebp]
	push	ecx
	call	DWORD PTR __imp__BitBlt@36
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 374  :          EndPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$140350[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 379  : 
; 380  :     //has the user resized the client area?
; 381  : 		case WM_SIZE:
; 382  : 		  {
; 383  :         //if so we need to update our variables so that any drawing
; 384  :         //we do using cxClient and cyClient is scaled accordingly
; 385  : 			  cxClient = LOWORD(lParam);
...
; 387  : 
; 388  :         //now to resize the backbuffer accordingly. First select
; 389  :         //the old bitmap back into the DC
; 390  : 			  SelectObject(hdcBackBuffer, hOldBitmap);
...
; 391  : 
; 392  :         //don't forget to do this or you will get resource leaks
; 393  :         DeleteObject(hBitmap); 
...
; 394  : 
; 395  : 			  //get the DC for the application
; 396  :         HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$140358[ebp], eax

; 397  : 
; 398  : 			  //create another bitmap of the same size and mode
; 399  :         //as the application
; 400  :         hBitmap = CreateCompatibleBitmap(hdc,
; 401  : 											  cxClient,
; 402  : 											  cyClient);
	...
	mov	ecx, DWORD PTR ?cxClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA
	push	ecx
	mov	edx, DWORD PTR _hdc$140358[ebp]
	push	edx
	call	DWORD PTR __imp__CreateCompatibleBitmap@12
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 404  : 			  ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$140358[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
	call	DWORD PTR __imp__ReleaseDC@8
...
; 405  : 			  
; 406  : 			  //select the new bitmap into the DC
; 407  :         SelectObject(hdcBackBuffer, hBitmap);
...
; 414  : 			 {
; 415  : 
; 416  :          //clean up our backbuffer objects
; 417  :          SelectObject(hdcBackBuffer, hOldBitmap);
...
; 421  :          
; 422  : 
; 423  :          // kill the application, this sends a WM_QUIT message  
...
; 429  :      }//end switch
; 430  : 
; 431  :      //this is where all the messages not specifically handled by our 
; 432  : 		 //winproc are sent to be processed
...
; 434  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN57@WindowProc
...
PUBLIC	??_C@_1HM@NHOAALEE@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ ; `string'
EXTRN	__imp__GetStockObject@4:PROC
EXTRN	__wassert:PROC
;	COMDAT ??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL?$AA?$AA@
; File c:\users\pedro\documents\github\raveniagv2\common\misc\cgdi.h
CONST	SEGMENT
??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL?$AA?$AA@ DB 'm'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1HM@NHOAALEE@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
CONST	SEGMENT
??_C@_1HM@NHOAALEE@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 'P', 00H, 'e', 00H, 'd', 00H, 'r', 00H, 'o'
	DB	00H, '\', 00H, 'D', 00H, 'o', 00H, 'c', 00H, 'u', 00H, 'm', 00H
	DB	'e', 00H, 'n', 00H, 't', 00H, 's', 00H, '\', 00H, 'G', 00H, 'i'
	DB	00H, 't', 00H, 'H', 00H, 'u', 00H, 'b', 00H, '\', 00H, 'R', 00H
	DB	'a', 00H, 'v', 00H, 'e', 00H, 'n', 00H, 'I', 00H, 'A', 00H, 'G'
	DB	00H, 'v', 00H, '2', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
...
; 177  :     assert(m_hdc == NULL);
	...
	push	177					; 000000b1H
	push	OFFSET ??_C@_1HM@NHOAALEE@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\buckland_chapter7 to 10_raven\raven_game.h
_TEXT	ENDS
...
$T150147 = -280						; size = 4
$T140401 = -276						; size = 32
_err$140400 = -240					; size = 4
_bDone$140390 = -229					; size = 1
_timer$140389 = -224					; size = 104
...
; 445  : {
	...
	mov	BYTE PTR $T150163[ebp], 0

; 446  :   MSG msg;
; 447  :   //handle to our window
; 448  : 	HWND						hWnd;
; 449  : 
; 450  :  //the window class structure
; 451  : 	WNDCLASSEX     winclass;
; 452  : 
; 453  :   // first fill in the window class stucture
; 454  : 	winclass.cbSize        = sizeof(WNDCLASSEX);

	mov	DWORD PTR _winclass$[ebp], 48		; 00000030H

; 455  : 	winclass.style         = CS_HREDRAW | CS_VREDRAW;

	mov	DWORD PTR _winclass$[ebp+4], 3

; 456  :   winclass.lpfnWndProc   = WindowProc;

	mov	DWORD PTR _winclass$[ebp+8], OFFSET ?WindowProc@@YGJPAUHWND__@@IIJ@Z ; WindowProc

; 457  :   winclass.cbClsExtra    = 0;

	mov	DWORD PTR _winclass$[ebp+12], 0

; 458  :   winclass.cbWndExtra    = 0;

	mov	DWORD PTR _winclass$[ebp+16], 0

; 459  :   winclass.hInstance     = hInstance;

	mov	eax, DWORD PTR _hInstance$[ebp]
	mov	DWORD PTR _winclass$[ebp+20], eax

; 460  :   winclass.hIcon         = LoadIcon(NULL, IDI_APPLICATION);
...
; 461  :   winclass.hCursor       = LoadCursor(NULL, IDC_ARROW);
...
; 462  :   winclass.hbrBackground = NULL;

	mov	DWORD PTR _winclass$[ebp+32], 0

; 463  :   winclass.lpszMenuName  = MAKEINTRESOURCE(IDR_MENU1);

	mov	DWORD PTR _winclass$[ebp+36], 101	; 00000065H

; 464  :   winclass.lpszClassName = g_szWindowClassName;

	mov	ecx, DWORD PTR ?g_szWindowClassName@@3PADA ; g_szWindowClassName
	mov	DWORD PTR _winclass$[ebp+40], ecx

; 465  : 	winclass.hIconSm       = LoadIcon(NULL, IDI_APPLICATION);
...
; 468  :   if (!RegisterClassEx(&winclass))
...
; 469  :   {
; 470  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);

	mov	esi, esp
	push	0
	push	OFFSET $SG140383
	push	OFFSET $SG140384
	push	0
...
; 479  : 		 //create the window and assign its ID to hwnd    
; 480  :      hWnd = CreateWindowEx (NULL,                 // extended style
; 481  :                             g_szWindowClassName,  // window class name
; 482  :                             g_szApplicationName,  // window caption
; 483  :                             WS_OVERLAPPED | WS_VISIBLE | WS_CAPTION | WS_SYSMENU,  // window style
; 484  :                             GetSystemMetrics(SM_CXSCREEN)/2 - WindowWidth/2,
; 485  :                             GetSystemMetrics(SM_CYSCREEN)/2 - WindowHeight/2,                    
; 486  :                             WindowWidth,     // initial x size
; 487  :                             WindowHeight,    // initial y size
; 488  :                             NULL,                 // parent window handle
; 489  :                             NULL,                 // window menu handle
; 490  :                             hInstance,            // program instance handle
; 491  :                             NULL);                // creation parameters
...
; 492  : 
; 493  :      //make sure the window creation has gone OK
; 494  :      if(!hWnd)
...
; 495  :      {
; 496  :        MessageBox(NULL, "CreateWindowEx Failed!", "Error!", 0);

	mov	esi, esp
	push	0
	push	OFFSET $SG140387
	push	OFFSET $SG140388
	push	0
	call	DWORD PTR __imp__MessageBoxA@16
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 498  : 
; 499  :      
; 500  :     //make the window visible
; 501  :     ShowWindow (hWnd, iCmdShow);
...
; 503  :    
; 504  :     //create a timer
; 505  :     PrecisionTimer timer(FrameRate);

	sub	esp, 8
	fld	QWORD PTR __real@404e000000000000
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _timer$140389[ebp]
...
; 509  : 
; 510  :     //enter the message loop
; 511  :     bool bDone = false;

	mov	BYTE PTR _bDone$140390[ebp], 0
$LN7@WinMain:

; 512  : 
; 513  :     while(!bDone)

	movzx	ecx, BYTE PTR _bDone$140390[ebp]
	test	ecx, ecx
	jne	$LN6@WinMain
$LN5@WinMain:
...
; 516  :       {
; 517  :         if( msg.message == WM_QUIT ) 

	cmp	DWORD PTR _msg$[ebp+4], 18		; 00000012H
	jne	SHORT $LN3@WinMain

; 518  :         {
; 519  :           // Stop loop if it's a quit message
; 520  : 	        bDone = true;

	mov	BYTE PTR _bDone$140390[ebp], 1
...
; 529  : 
; 530  :       if (timer.ReadyForNextFrame() && msg.message != WM_QUIT)
...
; 544  : 
; 545  :   catch (const std::runtime_error& err)
; 546  :   {
; 547  :     ErrorBox(std::string(err.what()));

	mov	esi, esp
	mov	ecx, DWORD PTR _err$140400[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _err$140400[ebp]
...
; 549  :     delete g_pRaven;
	...
	mov	ecx, DWORD PTR $T150148[ebp]
	mov	DWORD PTR $T150147[ebp], ecx
...
; 551  :     return 0;
	...
	mov	eax, DWORD PTR $T150151[ebp]
	jmp	SHORT $LN11@WinMain
$LN20@WinMain:

; 553  :   
; 554  :  //tidy up
; 555  :  UnregisterClass( g_szWindowClassName, winclass.hInstance );
...
; 556  :  delete g_pRaven;
	...
	mov	DWORD PTR $T150152[ebp], ecx
	cmp	DWORD PTR $T150152[ebp], 0
	je	SHORT $LN15@WinMain
	push	1
	mov	ecx, DWORD PTR $T150152[ebp]
	call	??_GRaven_Game@@QAEPAXI@Z
...
PUBLIC	??_C@_1JA@PPIEHGMK@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ ; `string'
...
; File c:\users\pedro\documents\github\raveniagv2\common\time\precisiontimer.h
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1JA@PPIEHGMK@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
CONST	SEGMENT
??_C@_1JA@PPIEHGMK@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 'P', 00H, 'e', 00H, 'd', 00H, 'r', 00H, 'o'
	DB	00H, '\', 00H, 'D', 00H, 'o', 00H, 'c', 00H, 'u', 00H, 'm', 00H
	DB	'e', 00H, 'n', 00H, 't', 00H, 's', 00H, '\', 00H, 'G', 00H, 'i'
...
$LN4@ReadyForNe:
	push	90					; 0000005aH
	push	OFFSET ??_C@_1JA@PPIEHGMK@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAP?$AAe?$AAd?$AAr?$AAo?$AA?2?$AAD?$AAo?$AAc?$AAu?$AAm?$AAe?$AAn?$AAt?$AAs?$AA?2?$AAG?$AAi?$AAt?$AAH?$AAu?$AAb?$AA?2@
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\misc\windowutils.h
...
PUBLIC	??_C@_1IC@FOCLLJPM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
;	COMDAT ??_C@_1IC@FOCLLJPM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IC@FOCLLJPM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
...
; 929  : 		_DEBUG_POINTER(_Ptr);
	...
	push	929					; 000003a1H
	push	OFFSET ??_C@_1IC@FOCLLJPM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
	mov	eax, DWORD PTR __Ptr$[ebp]
	push	eax
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$142220[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$142220[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$142220[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T150262[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T150262[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$142199[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$142199[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; File c:\users\pedro\documents\github\raveniagv2\common\debug\debugconsole.h
CONST	SEGMENT
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T150359[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T150360[ebp], edx
	lea	eax, DWORD PTR $T150359[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150360[ebp]
	push	ecx
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T150363[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T150363[ebp]
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T150525[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145217[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T150525[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@3
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150526[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150526[ebp]
	jmp	$LN7@operator@3
$LN3@operator@3:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150527[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150527[ebp]
$LN7@operator@3:
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T150544[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145232[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T150544[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@4
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150545[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150545[ebp]
	jmp	$LN7@operator@4
$LN3@operator@4:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150546[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150546[ebp]
$LN7@operator@4:
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 5
	mov	DWORD PTR __Idx$146357[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR __Idx$146357[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+4]
	push	eax
...
; 967  : 		return (*(end() - 1));
	...
	push	1
	lea	eax, DWORD PTR $T150628[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150627[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR $T150626[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T150628[ebp]
...
PUBLIC	??_C@_1IE@FLDGIGNK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IE@FLDGIGNK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IE@FLDGIGNK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 181  : 				_DEBUG_ERROR("ITERATOR LIST CORRUPTED!");
	...
	push	181					; 000000b5H
	push	OFFSET ??_C@_1IE@FLDGIGNK@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	eax, DWORD PTR $T150663[ebp]
	or	eax, 1
	mov	DWORD PTR $T150663[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150697[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150697[ebp], 0
...
; File c:\program files\microsoft visual studio 10.0\vc\include\sstream
rdata$r	SEGMENT
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150715[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150715[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T150715[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T150715[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T150745[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150745[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T150779[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150780[ebp], eax
	lea	ecx, DWORD PTR $T150779[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150780[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T150837[ebp], eax
	lea	ecx, DWORD PTR __Lock$104593[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150837[ebp]
...
tv195 = -32						; size = 4
$T150846 = -28						; size = 4
__Oldptr$146475 = -24					; size = 4
__Newptr$146474 = -20					; size = 4
__Inc$146469 = -16					; size = 4
__Newsize$146468 = -12					; size = 4
__Oldsize$146467 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150846[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150846[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$146467[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$146467[ebp]
	mov	DWORD PTR __Newsize$146468[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$146468[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$146468[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$146469[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$146469[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$146469[ebp]
	cmp	edx, DWORD PTR __Newsize$146468[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$146469[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$146469[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$146468[ebp]
	add	ecx, DWORD PTR __Inc$146469[ebp]
	mov	DWORD PTR __Newsize$146468[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$146474[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$146475[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$146467[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$146467[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$146475[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$146474[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$146474[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$146474[ebp]
	add	edx, DWORD PTR __Newsize$146468[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$146474[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$146475[ebp]
	add	eax, DWORD PTR __Newptr$146474[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$146467[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$146475[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T150866[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T150866[ebp]
	push	ecx
...
; 199  : 			if (!_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150867[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150867[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150894[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150894[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
...
; 376  : 		return (_Tmp -= _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T150924[ebp]
	or	edx, 1
	mov	DWORD PTR $T150924[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T150924[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T150924[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
tv91 = -148						; size = 4
$T150951 = -144						; size = 4
__Nul$146660 = -136					; size = 32
__Str$146658 = -96					; size = 32
__Str$146655 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$146655[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$146655[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150951[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150951[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146655[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$146658[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T150951[ebp]
	or	edx, 1
	mov	DWORD PTR $T150951[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146658[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$146660[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$146660[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150951[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T150951[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T150951[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
PUBLIC	??_C@_0EC@OCEODDOH@c?3?2Program?5Files?2Microsoft?5Visua@ ; `string'
...
;	COMDAT ??_C@_0EC@OCEODDOH@c?3?2Program?5Files?2Microsoft?5Visua@
; File c:\program files\microsoft visual studio 10.0\vc\include\xiosbase
CONST	SEGMENT
??_C@_0EC@OCEODDOH@c?3?2Program?5Files?2Microsoft?5Visua@ DB 'c:\Program '
	DB	'Files\Microsoft Visual Studio 10.0\VC\include\xiosbase', 00H ; `string'
; Function compile flags: /Odtp /RTCsu
CONST	ENDS
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	push	564					; 00000234H
	push	OFFSET ??_C@_0EC@OCEODDOH@c?3?2Program?5Files?2Microsoft?5Visua@
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T151031[ebp], eax
	cmp	DWORD PTR $T151031[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T151031[ebp]
...
PUBLIC	??_C@_0ED@PMBDCKDD@c?3?2Program?5Files?2Microsoft?5Visua@ ; `string'
EXTRN	??0_Mutex@std@@QAE@XZ:PROC			; std::_Mutex::_Mutex
;	COMDAT ??_C@_0ED@PMBDCKDD@c?3?2Program?5Files?2Microsoft?5Visua@
; File c:\program files\microsoft visual studio 10.0\vc\include\streambuf
CONST	SEGMENT
??_C@_0ED@PMBDCKDD@c?3?2Program?5Files?2Microsoft?5Visua@ DB 'c:\Program '
	DB	'Files\Microsoft Visual Studio 10.0\VC\include\streambuf', 00H ; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
; 25   : 		{	// construct with no buffers
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	push	24					; 00000018H
	push	OFFSET ??_C@_0ED@PMBDCKDD@c?3?2Program?5Files?2Microsoft?5Visua@
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	push	eax
	push	4
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T151046[ebp], eax
	cmp	DWORD PTR $T151046[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T151046[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
_TEXT	SEGMENT
__Size$146851 = -28					; size = 4
__Ptr$146844 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$146844[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$146844[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEIXZ ; std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::size
	mov	DWORD PTR __Size$146851[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 5
	add	eax, DWORD PTR __Ptr$146844[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$146851[ebp]
	shl	edx, 5
	add	edx, DWORD PTR __Ptr$146844[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$146844[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T151077[ebp], al
	movzx	edx, BYTE PTR $T151077[ebp]
	push	edx
...
PUBLIC	??_C@_1IA@ICLPFHIH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1IA@ICLPFHIH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IA@ICLPFHIH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 70   : 			_DEBUG_ERROR("vector iterator not dereferencable");
	...
	push	70					; 00000046H
	push	OFFSET ??_C@_1IA@ICLPFHIH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$146911[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$146911[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$146911[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$146911[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T151119[ebp]
	or	edx, 1
	mov	DWORD PTR $T151119[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T151126 = -64						; size = 4
$T151125 = -60						; size = 12
__Pfmod$144499 = -48					; size = 4
__Pf$144483 = -44					; size = 4
__Id$144482 = -40					; size = 4
__Psave$144470 = -32					; size = 4
__Lock$144469 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144469[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144470[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144470[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144470[ebp]
	mov	DWORD PTR __Pf$144483[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$144470[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T151125[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T151125[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144470[ebp]
	mov	DWORD PTR __Pf$144483[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144470[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144470[ebp]
	mov	DWORD PTR __Pfmod$144499[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144499[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144483[ebp]
	mov	DWORD PTR $T151126[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144469[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T151126[ebp]
$LN8@use_facet:
...
PUBLIC	??_C@_0EB@PPLMFHFB@c?3?2Program?5Files?2Microsoft?5Visua@ ; `string'
;	COMDAT ??_C@_0EB@PPLMFHFB@c?3?2Program?5Files?2Microsoft?5Visua@
CONST	SEGMENT
??_C@_0EB@PPLMFHFB@c?3?2Program?5Files?2Microsoft?5Visua@ DB 'c:\Program '
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	or	eax, 1
	mov	DWORD PTR $T151162[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T151156[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T151162[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T151162[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T151158[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T151174[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T151174[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T151235[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T151235[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T151235[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T151235[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T151235[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T151235[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T151235[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T151235[ebp+12]
...
PUBLIC	??_C@_1IC@OPMPOAHH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
;	COMDAT ??_C@_1IC@OPMPOAHH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
CONST	SEGMENT
??_C@_1IC@OPMPOAHH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 2419 : 		_DEBUG_RANGE((const _Elem *)_First, _Last);
	...
	push	2419					; 00000973H
	push	OFFSET ??_C@_1IC@OPMPOAHH@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
	mov	eax, DWORD PTR __Last$[ebp]
	push	eax
	mov	ecx, DWORD PTR __First$[ebp]
	push	ecx
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T151342[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T151342[ebp], 0
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	movzx	edx, BYTE PTR $T151356[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
PUBLIC	??_C@_1IA@PMGENLIM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ ; `string'
;	COMDAT ??_C@_1IA@PMGENLIM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
; File c:\program files\microsoft visual studio 10.0\vc\include\memory
CONST	SEGMENT
??_C@_1IA@PMGENLIM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@ DB 'c'
	DB	00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'g', 00H
	DB	'r', 00H, 'a', 00H, 'm', 00H, ' ', 00H, 'F', 00H, 'i', 00H, 'l'
	DB	00H, 'e', 00H, 's', 00H, '\', 00H, 'M', 00H, 'i', 00H, 'c', 00H
	DB	'r', 00H, 'o', 00H, 's', 00H, 'o', 00H, 'f', 00H, 't', 00H, ' '
...
; 425  : 	_DEBUG_RANGE(_First, _Last);
	...
	push	425					; 000001a9H
	push	OFFSET ??_C@_1IA@PMGENLIM@?$AAc?$AA?3?$AA?2?$AAP?$AAr?$AAo?$AAg?$AAr?$AAa?$AAm?$AA?5?$AAF?$AAi?$AAl?$AAe?$AAs?$AA?2?$AAM?$AAi?$AAc?$AAr?$AAo?$AAs?$AAo?$AAf?$AAt?$AA?5?$AAV?$AAi?$AAs?$AAu?$AAa@
	mov	eax, DWORD PTR __Last$[ebp]
	push	eax
	mov	ecx, DWORD PTR __First$[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\pedro\documents\github\raveniagv2\common\misc\utils.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\program files\microsoft visual studio 10.0\vc\include\limits
text$yc	ENDS
