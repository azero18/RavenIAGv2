; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\Victor\Desktop\Raven-IAG\RavenIAGv2\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG27976 DB	'explore', 00H
$SG27978 DB	'think', 00H
	ORG $+2
$SG27980 DB	'arrive_at_position', 00H
	ORG $+1
$SG27982 DB	'seek_to_position', 00H
	ORG $+3
$SG27984 DB	'follow_path', 00H
$SG27986 DB	'traverse_edge', 00H
	ORG $+2
$SG27988 DB	'move_to_position', 00H
	ORG $+3
$SG27990 DB	'get_health', 00H
	ORG $+1
$SG27992 DB	'get_shotgun', 00H
$SG27994 DB	'get_railgun', 00H
$SG27996 DB	'get_rocket_launcher', 00H
$SG27998 DB	'wander', 00H
	ORG $+1
$SG28000 DB	'negotiate_door', 00H
	ORG $+1
$SG28002 DB	'attack_target', 00H
	ORG $+2
$SG28004 DB	'hunt_target', 00H
$SG28006 DB	'strafe', 00H
	ORG $+1
$SG28008 DB	'adjust_range', 00H
	ORG $+3
$SG28010 DB	'say_phrase', 00H
	ORG $+1
$SG28012 DB	'think_Z', 00H
$SG28014 DB	'UNKNOWN GOAL TYPE!', 00H
CONST	ENDS
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\goals\raven_goal_types.cpp
_BSS	SEGMENT
...
; File c:\users\victor\desktop\raven-iag\raveniagv2\buckland_chapter7 to 10_raven\goals\raven_goal_types.h
rdata$r	SEGMENT
...
; 20   :     return "think";
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T31643[ebp]
	or	eax, 1
	mov	DWORD PTR $T31643[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	$LN23@Convert
$LN18@Convert:
...
; 24   :     return "arrive_at_position";
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T31643[ebp]
	or	ecx, 1
	mov	DWORD PTR $T31643[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	$LN23@Convert
$LN17@Convert:
...
; 85   : 
; 86   :   case goal_think_Z: //NEW: para reconhecer o goal_think type
; 87   : 
; 88   : 	return "think_Z";
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$28865[ebp], eax
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$28865[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$28865[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T31709[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T31709[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$29507[ebp], eax

; 1119 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$29507[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T31801[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T31801[ebp], 0
	...
	mov	ecx, DWORD PTR $T31801[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T31801[ebp]
