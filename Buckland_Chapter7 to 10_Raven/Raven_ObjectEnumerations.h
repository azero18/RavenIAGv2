...
enum 
{
  ...
  type_sliding_door,
  type_door_trigger,
  type_bot_modified //NEW: adicionado um novo tipo de bot, o "bot Z"
};
...
inline std::string GetNameOfType(int w)
{
  ...
  case type_bot_modified: //NEW: adicionando case para novo tipo criado

	s =  "bot Z"; break;   //NEW: retorna o nome do bot Z
