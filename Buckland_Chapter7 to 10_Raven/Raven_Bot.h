...
protected:
  ...
  //NEW: numero de vezes que esse bot foi morto
  int                                m_iDeaths;

  //NEW: tempo que esse bot "nasceu"
  double                             m_dSpawnTime;

  //NEW: tempo que esse bot foi morto
  double                             m_dTimeOfDeath;

  //NEW: tempo total que esse bot sobreviveu no jogo
  double                             m_dSurvivedTime;
...
public:
  ...
  //NEW: acesso ao numero de mortes
  int           Deaths()const{return m_iDeaths;}

  //NEW: acesso ao tempo de sobrevivencia
  double        TimeSurvive()const{return m_dSurvivedTime;}

  //NEW: aumenta o contador de mortes
  void          IncrementDeaths(){++m_iDeaths;}

  //NEW: aumenta o contador de tempo de sobrevivencia
  void          IncrementSurviveTime(){m_dSurvivedTime+=(m_dTimeOfDeath-m_dSpawnTime);}
  ...
  //NEW: marca a hora do "nascimento" do bot
  void          SetSpawnTime(){m_dSpawnTime = (double)Clock->GetCurrentTime();}

  //NEW: marca a hora da morte do bot
  void          SetTimeOfDeath(){m_dTimeOfDeath = (double)Clock->GetCurrentTime();}
